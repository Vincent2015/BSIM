function fullAvatarEditor() {
	var id				= 'message/angular/lib/avatarEditUpload/scripts/fullAvatarEditor'			//flash文件的ID
	var file			= 'message/angular/lib/avatarEditUpload/scripts/fullAvatarEditor.swf';		//flash文件的路径
