...
var curConfig = {
	...
	selectNew: false,//新元素不选中imcustomize!!!yangjz0
	dimensions: [640, 480]
};
...
//							}
				...
				break;
			case "multiselect":
				return false; //禁用拖选 imcustomize!!!yangjz0
				real_x *= current_zoom;
				real_y *= current_zoom;
				assignAttributes(rubberBox, {
...
//				tlist.appendItem(translateOrigin);
				...
				points = curDis>380?[{'x':x0-1.4,'y':y0-0.5},{'x':x0-2.34,'y':y0-2.4},{'x':x0-1.85,'y':y0-3.82},{'x':x0-1.35,'y':y0-5.24},{'x':x0+0.56,'y':y0-6.16},{'x':x0+1.97,'y':y0-5.67},{'x':x0+curDis-80,'y':y0-20},{'x':x0+curDis-100,'y':y0-50},{'x':x0+curDis-100,'y':y0+50},{'x':x0+curDis-80,'y':y0+20}]:
					[{'x':x0-(1.4*ratio),'y':y0-(0.5*ratio)},{'x':x0-(2.34*ratio),'y':y0-(2.4*ratio)},{'x':x0-(1.85*ratio),'y':y0-(3.82*ratio)},{'x':x0-(1.35*ratio),'y':y0-(5.24*ratio)},{'x':x0+(0.56*ratio),'y':y0-(6.16*ratio)},{'x':x0+(1.97*ratio),'y':y0-(5.67*ratio)},{'x':x0+curDis-(80*ratio),'y':y0-(20*ratio)},{'x':x0+curDis-(100*ratio),'y':y0-(50*ratio)},{'x':x0+curDis-(100*ratio),'y':y0+(50*ratio)},{'x':x0+curDis-(80*ratio),'y':y0+(20*ratio)}],
			...
			current_d = "M "+start_x+","+start_y+" L "+start_x+","+start_y+//鐐�
						...
						" L "+rPoints[6]['x']+","+rPoints[6]['y']+//鐐逛簩
						" L "+rPoints[7]['x']+","+rPoints[7]['y']+//鐐逛笁
						" L "+real_x+","+real_y+//鐐瑰洓(绠ご椤剁偣)
						" L "+rPoints[8]['x']+","+rPoints[8]['y']+//鐐逛簲
						" L "+rPoints[9]['x']+","+rPoints[9]['y']+//鐐瑰叚
						" L "+start_x+","+start_y+" z";//闂悎璺緞鍥炲埌璧风偣
