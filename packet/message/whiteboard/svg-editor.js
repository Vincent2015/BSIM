...
//									$.ajax({
//										type:"post",
//										url:"http://im.yyuap.com/sysadmin/rest/resource/yonyou/udn/upload?name="+file.name+"&creator=wangxin0.udn.yonyou&mediaType=1&token=071abda7-269d-4d53-91bd-b7683b878b4b",
//							            type: 'POST',  
//							            data: data,  
//							            dataType: 'JSON',  
//							            cache: false,  
...
//												M = 100,
//												Q = new Image;
//											Q.src = 'http://im.yyuap.com/sysadmin/rest/resource/yonyou/udn/download?token=071abda7-269d-4d53-91bd-b7683b878b4b&mediaType=2&attachId='+data.attachId;
//											Q.style.opacity = 0;
//											Q.onload = function() {
//												J = Q.offsetWidth;
//												M = Q.offsetHeight;
...
//									}
				...
				var img_import = $('<input type="file" id="add_pic_to_whbd">').change(import_image);
