...
(function(){function a(a){return 10>a?"0"+a:a}function c(a){f.lastIndex=0;return f.test(a)?'"'+a.replace(f,function(a){var c=n[a];return"string"===typeof c?c:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function d(a,e){var f,n,y,t,v=g,B,p=e[a];p&&"object"===typeof p&&"function"===typeof p.toJSON&&(p=p.toJSON(a));"function"===typeof u&&(p=u.call(e,a,p));switch(typeof p){case "string":return c(p);case "number":return isFinite(p)?String(p):"null";case "boolean":case "null":return String(p);
case "object":if(!p)return"null";g+=h;B=[];if("[object Array]"===Object.prototype.toString.apply(p)){t=p.length;for(f=0;f<t;f+=1)B[f]=d(f,p)||"null";y=0===B.length?"[]":g?"[\n"+g+B.join(",\n"+g)+"\n"+v+"]":"["+B.join(",")+"]";g=v;return y}if(u&&"object"===typeof u)for(t=u.length,f=0;f<t;f+=1)"string"===typeof u[f]&&(n=u[f],(y=d(n,p))&&B.push(c(n)+(g?": ":":")+y));else for(n in p)Object.prototype.hasOwnProperty.call(p,n)&&(y=d(n,p))&&B.push(c(n)+(g?": ":":")+y);y=0===B.length?"{}":g?"{\n"+g+B.join(",\n"+
g)+"\n"+v+"}":"{"+B.join(",")+"}";g=v;return y}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()});var e,f,g,h,n,u;"function"!==typeof JSON.stringify&&(f=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
...
JSJaCJSON.toString=function(a){var c={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},d={array:function(a){var c=["["],g,h,n,u=a.length,x;for(n=0;n<u;n+=1)if(x=a[n],h=d[typeof x])try{x=h(x),"string"==typeof x&&(g&&(c[c.length]=","),c[c.length]=x,g=!0)}catch(r){}c[c.length]="]";return c.join("")},"boolean":function(a){return String(a)},"null":function(){return"null"},number:function(a){return isFinite(a)?String(a):"null"},object:function(a){if(a){if(a instanceof Array)return d.array(a);
var c=[],g,h,n,u;c.push("{");for(n in a)if(a.hasOwnProperty(n)&&(u=a[n],h=d[typeof u]))try{u=h(u),"string"==typeof u&&(g&&(c[c.length]=","),c.push(d.string(n),":",u),g=!0)}catch(x){}c[c.length]="}";return c.join("")}return"null"},string:function(a){/["\\\x00-\x1f]/.test(a)&&(a=a.replace(/([\x00-\x1f\\"])/g,function(a,d){var e=c[d];if(e)return e;e=d.charCodeAt();return"\\u00"+Math.floor(e/16).toString(16)+(e%16).toString(16)}));return'"'+a+'"'}};switch(typeof a){case "object":return d.object(a);case "array":return d.array(a)}};
...
function rstr2any(a,c){var d=c.length,e,f,g,h,n,u=Array(Math.ceil(a.length/2));for(e=0;e<u.length;e++)u[e]=a.charCodeAt(2*e)<<8|a.charCodeAt(2*e+1);var x=Math.ceil(8*a.length/(Math.log(c.length)/Math.log(2))),r=Array(x);for(f=0;f<x;f++){n=[];for(e=h=0;e<u.length;e++)if(h=(h<<16)+u[e],g=Math.floor(h/d),h-=g*d,0<n.length||0<g)n[n.length]=g;r[f]=h;u=n}d="";for(e=r.length-1;0<=e;e--)d+=c.charAt(r[e]);return d}
...
jQuery(this),f=jQuery(".uploadify").length+1,g='<span id="'+c.uploadIdPrefix+f+'-queue" class="uploadify-queue"></span>',h=jQuery("#"+c.processId);0>=jQuery("#"+c.uploadIdPrefix+f+"-queue").length&&c.showProcess&&h.append(g);FileUpload.getInstanceByInputId(c.inputId).fileObj={uploadAllowed:!0,fileInput:a,uploadFileList:h.find("#"+c.uploadIdPrefix+f+"-queue"),url:c.uploader,fileFilter:[],uploadOver:!1,filter:function(a){for(var d=[],e=c.fileTypeExts.split(";"),f=0,g=a.length;f<g;f++){var h=a[f];parseInt(FileUpload.formatFileSize(h.size,
!0))>c.fileSizeLimit?alert("\u6587\u4ef6"+h.name+"\u5927\u5c0f\u8d85\u51fa\u9650\u5236\uff01"):"*"==c.fileTypeExts||0<=jQuery.inArray(h.name.split(".").pop().toLowerCase(),e)?d.push(h):alert("\u6587\u4ef6"+h.name+"\u7c7b\u578b\u4e0d\u5141\u8bb8\uff01")}return d},funSelect:function(d){for(var g=0,h=d.length;g<h;g++){var r=d[g];filesIndex+=","+r.index;var C="unknown";r.name&&(C=r.name.substr(r.name.lastIndexOf(".")+1));C=jQuery(c.itemTemplate.replace(/\${fileID}/g,"fileupload_"+f+"_"+r.index).replace(/\${fileTypeIcon}/g,
"res/skin/default/icons/filetype/"+C+".png").replace(/\${fileName}/g,r.name).replace(/\${fileSize}/g,FileUpload.formatFileSize(r.size)).replace(/\${instanceID}/g,a.attr("id")).replace(/\${continueUpload}/g,"continueUpload_"+f+"_"+r.index));c.auto&&C.find(".uploadbtn").remove();var m=0,y="0KB",t="0%";c.breakPoints&&(t=this.funGetUploadedSize(r),m=t/r.size*100+"%",y=FileUpload.formatFileSize(t),t=(t/r.size*100).toFixed(2)+"%",C.find(".uploadify-progress-bar").css("width",m));this.uploadFileList.append(C);
c.showUploadedSize&&(m='<span class="progressnum"><span id="isUploadingFileSize_'+f+"_"+r.index+'" class="uploadedsize">'+y+'</span>/<span class="totalsize">${fileSize}</span></span>'.replace(/\${fileSize}/g,FileUpload.formatFileSize(r.size)),C.find(".uploadify-progress").after(m));c.showUploadedPercent&&(m='<span class="up_percent" style="display:none">'+t+"</span>",C.find(".uploadify-progress").after(m));c.onSelect&&c.onSelect(d);c.auto?this.funUploadFile(r):C.find(".uploadbtn").click(function(a){return function(){FileUpload.getInstanceByInputId(c.inputId).fileObj.funUploadFile(a)}}(r));
C.find(".delfilebtn").click(function(a){return function(){FileUpload.getInstanceByInputId(c.inputId).fileObj.funDeleteFile(a)}}(r));C.find("#btnstop").click(function(a){return function(){deletefilesIndex+=","+a.index}}(r));C.find("#continueUpload_"+f+"_"+r.index).click(function(a){var d=a.index;return function(){if(0<deletefilesIndex.length&&-1<deletefilesIndex.indexOf(","+d)){for(var a=deletefilesIndex.split(","),f="",e=0;e<a.length;e++)a[e]!=d&&""!=a[e]&&(f+=","+a[e]);deletefilesIndex=f}(a=FileUpload.getFile(d,
FileUpload.getInstanceByInputId(c.inputId).fileObj.fileFilter))&&FileUpload.getInstanceByInputId(c.inputId).fileObj.funUploadFile(a)}}(r))}},onProgress:function(a,d,e){a=h.find("#fileupload_"+f+"_"+a.index+" .uploadify-progress").attr("lastLoaded")||0;d<a&&(a=0);d-=parseInt(a);a=(d/e).toFixed(4);a=1<a?1:a;c.onUploadProgress&&c.onUploadProgress({percent:a,loaded:d,total:e})},funGetProgressWidth:function(a){},funGetUploadedSize:function(a){if(c.getUploadedSize)return c.getUploadedSize(a);if(c.saveInfoLocal)return parseInt(SNSStorage.getLocalVal(a.name))||
...
isDelete=!0}});return this},funUploadFile:function(a){var e=!1,g=a,r=h.find("#fileupload_"+f+"_"+a.index),C=function(){FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&(r.find(".uploadify-progress-bar").css("width","100%"),c.showUploadedSize&&r.find(".uploadedsize").text(r.find(".totalsize").text()),c.showUploadedPercent&&r.find(".up_percent").text("100%"))};try{e=new XMLHttpRequest}catch(m){e=ActiveXobject("Msxml12.XMLHTTP")}if("undefined"==e)alert("\u6d4f\u89c8\u5668\u7248\u672c\u4e0d\u652f\u6301\uff0c\u8bf7\u66f4\u65b0\u7248\u672c");
else{31457280>=g.size||-1<g.type.indexOf("image/")?c.breakPoints=!1:c.breakPoints=!0;if(c.breakPoints){var y=a.name,t=a.id,v=a.index,B=a.size,p=parseInt(this.funGetUploadedSize(g));if(browserSys.firefox){var E=browserSys.firefox.split(".");a=6<E[0]&&15>E[0]?g.mozSlice(p,p+c.fileSplitSize):g.slice(p,p+c.fileSplitSize)}else browserSys.chrome?(E=browserSys.chrome.split("."),a=10<E[0]&&21>E[0]?g.webkitSlice(p,p+c.fileSplitSize):g.slice(p,p+c.fileSplitSize)):a=g.slice(p,p+c.fileSplitSize);a.name=y;a.id=
t;a.index=v}e.upload&&!1!==p&&e.upload.addEventListener("progress",function(d){FileUpload.getInstanceByInputId(c.inputId).fileObj.onProgress(a,d.loaded,g.size)},!1);var I=c.to;g.userJid=I;e.onreadystatechange=function(m){if(4==e.readyState){FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver=!0;if(200==e.status){m=JSON.parse(e.responseText);"success"==m.status&&(setTimeout(function(){h.find("#fileupload_"+f+"_"+g.index).fadeOut()},100),SNSStorage.removeLocal(a.name));var r=g.index;c.breakPoints?
(p+=c.fileSplitSize,"success"==m.status||isDelete?(FileUpload.getInstanceByInputId(c.inputId).fileObj.funSaveUploadedSize(g,p,!0),isDelete=!1):FileUpload.getInstanceByInputId(c.inputId).fileObj.funSaveUploadedSize(g,p,!1),-1<deletefilesIndex.indexOf(r)&&SNSStorage.removeLocal(g.name),p<B?(FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver=!1,-1<filesIndex.indexOf(","+r)&&-1==deletefilesIndex.indexOf(r)&&(browserSys.firefox?(r=browserSys.firefox.split("."),a=6<r[0]&&15>r[0]?g.mozSlice(p,
p+c.fileSplitSize):g.slice(p,p+c.fileSplitSize)):browserSys.chrome?(r=browserSys.chrome.split("."),a=10<r[0]&&21>r[0]?g.webkitSlice(p,p+c.fileSplitSize):g.slice(p,p+c.fileSplitSize)):a=g.slice(p,p+c.fileSplitSize),a.name=y,a.id=t,a.index=v,a.size=B,d(FileUpload.getInstanceByInputId(c.inputId).fileObj.url,e,a,c.formData,g.size,I))):C()):C();FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&(c.type==UPLOAD_AVATAR?c.onUploadSuccess&&c.onUploadSuccess(m):(m={id:Math.uuid(),body:{content:new SNSFile(a.name,
...
12289),CHATGROUP:new _Opcode("chatGroup",13057,13058),DEL_GROUPMEMBER:new _Opcode("delGroupMember",9792),OPERATE_WHITEBOARD:new _Opcode("operateWhiteBoard",10241),LISTEN_WHITEBOARD:new _Opcode("listenWhiteBoard",10241,10242),UPDATE_WHITEBOARD:new _Opcode("updateWhiteBoard",10245),PACKET_ERROR:new _Opcode("packetError",16384),STREAM_ERROR:new _Opcode("streamError",16640),MESSAGE_RANGE:new _Range(4096,8192),IQ_RANGE:new _Range(8192,12288),PRESENCE_RANGE:new _Range(12288,16384)},PACKET_STRUCT={CONSOLE_FRAME:new _Range(0,
...
-1!=a.indexOf("@")?a:a+"@"+m.DOMAIN.PUBACCOUNT:null}},g="im.yyuap.com",h="stellar.yyuap.com",n=5227,u=7075,x="http://im.yyuap.com/sysadmin/";jQuery.support.cors=!0;var r;-1<navigator.userAgent.indexOf("Safari")&&1>navigator.userAgent.indexOf("Chrome")?r=!1:(window.WebSocket=window.WebSocket||window.MozWebSocket,r=window.WebSocket?!0:!1);var C;C=window.localStorage?!0:!1;var m={RESOURCE:"web-v2.5",IS_ANONYMOUS:!0,MULTI_TENANCY:{ENABLE:!0,ETP_KEY:"etp",APP_KEY:"app",SEPARATOR:"."},RECEIPTSPACKET_AUTO:!1,
SENDINTERVAL:30,MULTIPARTYCALL:{ADDRESS:"http://dudu.yonyoutelecom.cn/httpIntf/createConference.do",RESTADDRESS:"https://im.yyuap.com/sysadmin/rest/user/voip/make",ACCOUNT:"",KEY:"",PHONESMAXLENGTH:200,PARTYMAXLENGTH:12},SUPPORT:{isWebSocketSupport:r,isLocalConnectionSupport:C},CONNECTION:{TIMERVAL:2E3,WAIT:300,SECURE:!1,ALLOW_PLAIN:!0,ENABLE_WEBSOCKET:!0,ENABLE_LOCAL_CONNECTION:!0,USE_HTTPS:!1,SERVER_NAME:g,HTTP_BASE:h,HTTP_BIND_PORT:u,WS_PORT:n},PING:{INTERVAL:3E4,DURATION:3E4,TIMEOUT:3E4},SERVLET:{FILE_UPLOAD_SERVLET:x+
"fileUpload",FILE_DOWNLOAD_SERVLET:x+"download",FILE_DELETE_SERVLET:x+"cancel",AVATAR_SERVLET:x+"avatar",REST_RESOURCE_SERVLET:x+"rest/resource/",REST_HISTORY_SERVLET:x+"rest/history/",REST_VERSION_SERVLET:x+"rest/version/",REST_USER_SERVLET:x+"rest/user/"},DOMAIN:{CHATROOM:"conference."+g,SEARCH:"search."+g,PUBACCOUNT:"pubaccount."+g},MESSAGE:{SEND_TIMEOUT:3E4,MAX_CHARACHER:1E3,REQUEST_RECEIPTS:!0},LOG:{ENABLE:!0,FILTER_LEVEL:3},BROWSER:function(){var a=navigator.userAgent.toLowerCase();return{version:(a.match(/.+(?:rv|it|ra|ie)[\/: ]([\d.]+)/)||
[])[1],safari:/webkit/.test(a),opera:/opera/.test(a),msie:/msie/.test(a)&&!/opera/.test(a),mozilla:/mozilla/.test(a)&&!/(compatible|webkit)/.test(a)}}(),getHttpBindUrl:function(){return(this.CONNECTION.USE_HTTPS?"https://":"http://")+this.CONNECTION.HTTP_BASE+":"+this.CONNECTION.HTTP_BIND_PORT+"/http-bind/"},getWebSocketUrl:function(){return(this.CONNECTION.USE_HTTPS?"wss://":"ws://")+this.CONNECTION.HTTP_BASE+":"+this.CONNECTION.WS_PORT},useWebSocket:function(){return this.SUPPORT.isWebSocketSupport&&
this.CONNECTION.ENABLE_WEBSOCKET},useLocalConnection:function(){return this.SUPPORT.isLocalConnectionSupport&&this.CONNECTION.ENABLE_LOCAL_CONNECTION},getConnectionArgObj:function(){var a={domain:this.CONNECTION.SERVER_NAME,resource:this.RESOURCE,allow_plain:this.CONNECTION.ALLOW_PLAIN,secure:this.CONNECTION.SECURE,register:!1};this.IS_ANONYMOUS&&(a.authtype="saslanon");return a}},y={CHAT:"chat",AWAY:"away",XA:"xa",DND:"dnd",UNAVAILABLE:"unavailable"},t={MIXED:"mixed",SIMPLE:"simple",TEXT:2,FILE:4,
IMAGE:8,SYSTEM:16,PUBLIC:32,AUDO:64,LOCATION:128,SHARE:256,WHITEBOARD:1024},v=function(){var a=function(){return{getVCard:function(a){var c={type:"get"};YYIMCommonUtil.isStringAndNotEmpty(a.jid)?c.to=a.jid:null;d.getInstance().send(new JumpPacket(c,OPCODE.VCARD.SEND),function(a,c){c.complete&&c.complete();var d=a.vcard||{};d.userId=f.getID(d.username);c.success&&c.success(d)},a)},setVCard:function(a){d.getInstance().send(new JumpPacket({type:"set",vcard:a.vcard},OPCODE.VCARD.SEND),function(a,c){c.complete&&
c.complete();c.success&&c.success()},a)},getVCards:function(a){d.getInstance().send(new JumpPacket({type:"roster"},OPCODE.VCARDS.SEND),function(a,c){var d=a.vcards||[];vcards=[];for(i=d.length;i--;){var l=d[i];l.userId=f.getID(l.username);vcards.push(l)}c.complete&&c.complete();c.success&&c.success(vcards)},a)},getRostersPresence:function(a){jQuery.ajax({url:m.SERVLET.REST_USER_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/"+k.getInstance().getUserID()+"/presence/detail?token="+k.getInstance().getToken()+
"&username="+a.username,type:"get",dataType:"json",cache:!1,success:function(c){a.success&&a.success(c)},error:function(){a.error&&a.error()},complete:function(){a.complete&&a.complete()}})}}}(),c=function(){return{getRosterItems:function(a){var c=new JumpPacket({},OPCODE.ROSTER_LIST.SEND);d.getInstance().send(c,function(a,c){if(c){c.complete&&c.complete();var d=a.items;if(0!==(d&&d.length||0)){for(var l=[],e=d.length,g={};e--;){var s=d[e],h=s.jid,s={id:f.getID(h),resource:f.getResource(h),ask:s.ask,
recv:s.recv,name:s.name,photo:s.photo,subscription:s.subscription,group:s.groups};f.getDomain(h)!==m.DOMAIN.PUBACCOUNT&&(l.push(s),g[s.id]||"none"!==s.subscription||1!==s.recv||(g[s.id]=s))}for(var L in g)k.getInstance().onSubscribe({from:g[L].id,type:"subscribe"});c.success&&c.success(JSON.stringify(l))}}},a)},deleteRosterItem:function(a){var c={type:"set",ns:NS_ROSTER,item:{jid:a.jid,subscription:"remove"}};d.getInstance().send(new JumpPacket(c,OPCODE.UPDATE_ROSTER.SEND),function(a,c){c.complete&&
c.complete();c.success&&c.success(f.getID(c.jid))},a)},queryRosterItem:function(a){var c={start:YYIMCommonUtil.isNumber(a.start)?a.start:0,size:YYIMCommonUtil.isNumber(a.size)?a.size:20,fields:["Username","Name"],search:a.keyword};d.getInstance().send(new JumpPacket(c,OPCODE.QUERY_USER.SEND),function(a,c){for(var d=a.items||[],l=[],e=d.length;e--;){var g=d[e],s=g.jid;s!==k.getInstance().getUserBareJID()&&l.push({id:f.getID(s),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?g.name:f.getID(s),photo:g.photo,
email:g.email})}c.complete&&c.complete();c.success&&c.success({start:a.start,total:a.total,items:l})},a)},updateRosterItem:function(a){for(var c=a.roster,l={item:{jid:c.jid,name:c.name,groups:[]}},e=(c=c.groups)?c.length:0;e--&&YYIMCommonUtil.isStringAndNotEmpty(c[e]);)l.item.groups=l.item.groups.concat(c[e]);d.getInstance().send(new JumpPacket(l,OPCODE.UPDATE_ROSTER.SEND),function(a,c){c.complete&&c.complete();400===a.code?c.error&&c.error(a):(a.to=f.getID(a.to),c.success&&c.success(a))},a)}}}(),
e=function(){function a(c){if(c){for(var d=c.members.length,l=[];d--;){var e=c.members[d];e.id=f.getID(e.jid);l.push(e)}return{id:f.getID(c.from),name:c.naturalLanguageName||c.name,photo:c.photo,numberOfMembers:c.numberOfMembers,superLarge:c.superLarge,collected:c.collected,type:c.type,creationdate:c.creationdate,creater:f.getID(c.operator),members:l,owners:c.owners}}}function c(a){if(a){for(var d=a.memberItems.length,l=[];d--;){var e=a.memberItems[d];e.id=f.getID(e.jid);l.push(e)}return{id:f.getID(a.from),
members:l}}}return{queryChatGroup:function(a){var c={start:YYIMCommonUtil.isNumber(a.start)?a.start:0,size:YYIMCommonUtil.isNumber(a.size)?a.size:20,search:a.keyword};d.getInstance().send(new JumpPacket(c,OPCODE.QUERY_CHATGROUP.SEND),function(a,c){for(var d=a.items||[],l=[],e=d.length;e--;){var g=d[e],s=g.jid;l.push({id:f.getID(s),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?g.name:f.getID(s)})}c.complete&&c.complete();c.success&&c.success({start:a.start,total:a.total,items:l})},a)},configChatGroup:function(a){var c=
{to:a.jid,roomname:a.name,roomdesc:a.desc,persistent:1,owners:[k.getInstance().getUserBareJID()],etp:m.MULTI_TENANCY.ETP_KEY,app:m.MULTI_TENANCY.APP_KEY};YYIMCommonUtil.isStringAndNotEmpty(a.photo)&&(c.photo=a.photo);d.getInstance().send(new JumpPacket(c,OPCODE.CONFIG_CHATGROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success()},a)},getChatGroups:function(c){jQuery.ajax({url:m.SERVLET.REST_USER_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/rooms?token="+k.getInstance().getToken()+
"&username="+k.getInstance().getUserID(),type:"get",dataType:"json",cache:!1,success:function(d){d=d.items;if(0!==(d&&d.length||0)){for(var l=[],e=d.length;e--;){var f=d[e];f.from=f.jid;(f=a(f))&&l.push(f)}c.success&&c.success(JSON.stringify(l))}},error:function(){c.error&&c.error()},complete:function(){c.complete&&c.complete()}})},getChatGroupInfo:function(a){var c={to:a.jid,type:"get",ns:NS_DISCO_INFO};d.getInstance().send(new JumpPacket(c,OPCODE.CHATGROUP_INFO.SEND),function(a,c){c.complete&&c.complete();
var d=a.roomname?a.roomname:f.getID(c.jid),l=a.description;c.success&&c.success({name:d,desc:l})},a)},createChatGroup:function(c){var l={id:c.id,naturalLanguageName:c.name,from:k.getInstance().getUserBareJID(),invitees:c.members};d.getInstance().send(new JumpPacket(l,OPCODE.CREATE_GROUP.SEND),function(c,d){d.complete&&d.complete();d.success&&d.success(a(c))},c)},inviteGroupMember:function(c){var l={id:c.id,to:c.to,from:k.getInstance().getUserBareJID(),invitees:c.members};d.getInstance().send(new JumpPacket(l,
...
OPCODE.KICK_GROUP_MEMBER.SEND),function(c,d){d.complete&&d.complete();d.success&&d.success(a(c))},c)},exitChatGroup:function(a){var c={id:a.id,from:k.getInstance().getUserBareJID(),to:a.to};d.getInstance().send(new JumpPacket(c,OPCODE.EXIT_GROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success({from:f.getID(a.from),id:a.id,to:f.getID(a.to)})},a)},handleChatGroup:a,transferChatGroupOwner:c,collectChatGroup:function(a){var c={id:a.id,from:k.getInstance().getUserBareJID(),to:a.to,type:a.type};
d.getInstance().send(new JumpPacket(c,OPCODE.COLLECT_GROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success({from:f.getID(c.to),id:a.id,to:k.getInstance().getUserID(),type:c.type,code:a.code,message:a.message})},a)},transferChatGroup:function(a){var l={id:a.id,to:a.to,from:k.getInstance().getUserBareJID(),newOwner:a.newOwner};d.getInstance().send(new JumpPacket(l,OPCODE.TRANSFER_GROUP.SEND),function(a,d){d.complete&&d.complete();d.success&&d.success(c(a))},a)},dismissChatGroup:function(a){var c=
{id:a.id,to:a.to,from:k.getInstance().getUserBareJID()};d.getInstance().send(new JumpPacket(c,OPCODE.DISMISS_GROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success({id:a.id,from:f.getID(a.from),to:f.getID(a.to)})},a)},getGroupSharedFiles:function(a){var c={token:k.getInstance().getToken(),username:k.getInstance().getUserID(),mucId:a.id,start:parseInt(a.start||0),size:parseInt(a.size||20)},d=m.SERVLET.REST_USER_SERVLET+"sharefiles/"+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+
"/muc",d=d+("?"+jQuery.param(c));jQuery.ajax({url:d,type:"get",dataType:"json",cache:!1,success:function(c){c=c.list;for(var d=[],l=c.length;l--;){var e=c[l];e.creator=f.getID(e.creator);d.push(e)}a.success&&a.success(d)},error:function(){a.error&&a.error()},complete:function(){a.complete&&a.complete()}})}}}(),g=function(){return{getGroupMembers:function(a){d.getInstance().send(new JumpPacket({type:"get",ns:NS_DISCO_ITEMS,to:a.jid},OPCODE.CHATGROUP_MEMBER_LIST.SEND),function(a,c){if(c){c.complete&&
c.complete();var d=a.items;if(0!==(d&&d.length||0)){for(var l=[],e=-1,g=d.length;++e<g;){var s=d[e];l.push({id:f.getID(s.jid),name:s.name,photo:s.photo,affiliation:s.affiliation})}c.success&&c.success(JSON.stringify(l))}}},a)}}}(),h=function(){return{getPubAccountItems:function(a){var c=new JumpPacket({type:"get",ns:NS_PUBACCOUNT,to:m.DOMAIN.PUBACCOUNT},OPCODE.PUBACCOUNT_LIST.SEND);d.getInstance().send(c,function(a,c){if(c){c.complete&&c.complete();var d=a.items;if(0!==(d&&d.length||0)){for(var l=
[],e=d.length||0;e--;){var g=d[e],s=g.jid,g={id:f.getID(s),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?g.name:f.getID(s),type:g.type};l.push(g)}c.success&&c.success(JSON.stringify(l))}}},a)},queryPubaccount:function(a){var c={start:YYIMCommonUtil.isNumber(a.start)?a.start:0,size:YYIMCommonUtil.isNumber(a.size)?a.size:20,fields:["Accountname","Name"],search:a.keyword};d.getInstance().send(new JumpPacket(c,OPCODE.QUERY_PUBACCOUNT.SEND),function(a,c){for(var d=a.items||[],l=[],e=d.length;e--;){var g=
d[e],s=g.jid;l.push({id:f.getID(s),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?g.name:f.getID(s),type:g.type})}c.complete&&c.complete();c.success&&c.success({start:a.start,total:a.total,items:l})},a)}}}(),n=function(){return{fullSyncRoster:function(a){d.getInstance().send(new JumpPacket({submits:a},OPCODE.FULL_SYNC_ROSTER.SEND))},deltaSyncRoster:function(a,c){var l={};0<a.length&&(l.removes=a);0<c.length&&(l.sets=c);(0<a.length||0<c.length)&&d.getInstance().send(new JumpPacket(l,OPCODE.DELTA_SYNC_ROSTER.SEND))},
fullSyncChatGroup:function(a){d.getInstance().send(new JumpPacket({submits:a},OPCODE.FULL_SYNC_CHATGROUP.SEND))},deltaSyncChatGroup:function(a,c){var l={};0<a.length&&(l.removes=a);0<c.length&&(l.sets=c);(0<a.length||0<c.length)&&d.getInstance().send(new JumpPacket(l,OPCODE.DELTA_SYNC_CHATGROUP.SEND))}}}();return{monitor:function(){var a=d.getInstance();a.registerHandler(OPCODE.UPDATE_ROSTER.KEY,function(a){var c=a.item;a=f.getID(a.item.jid);"both"===c.subscription?(F.log("update or add: "+JSON.stringify(c)),
k.getInstance().onRosterUpdateded({id:a,name:c.name,groups:c.groups})):"none"===c.subscription&&(F.log("delete: "+JSON.stringify(c)),k.getInstance().onRosterDeleted(a))});a.registerHandler(OPCODE.ON_GROUP_UPDATE.KEY,function(a){if(a=e.handleChatGroup(a))k.getInstance().onGroupUpdate(a)});a.registerHandler(OPCODE.ON_GROUP_TRANSFER.KEY,function(a){if(a=e.transferChatGroupOwner(a))k.getInstance().onTransferGroupOwner(a)});a.registerHandler(OPCODE.KICKED_GROUP.KEY,function(a){a={id:a.id,from:f.getID(a.from),
to:f.getID(a.to)};k.getInstance().onKickedOutGroup(a)});a.registerHandler(OPCODE.PUBACCOUNT_LIST.KEY,function(a){a=a.items;if(0!==(a&&a.length||0)){for(var c=[],d=a.length;d--;){var l=a[d],e=l.jid,l={id:f.getID(e),name:YYIMCommonUtil.isStringAndNotEmpty(l.name)?l.name:f.getID(e),type:l.type};c.push(l)}k.getInstance().onPubaccountUpdate(c)}})},getVCard:a.getVCard,setVCard:a.setVCard,getVCards:a.getVCards,getRostersPresence:a.getRostersPresence,getRosterItems:c.getRosterItems,deleteRosterItem:c.deleteRosterItem,
queryRosterItem:c.queryRosterItem,updateRosterItem:c.updateRosterItem,queryChatGroup:e.queryChatGroup,configChatGroup:e.configChatGroup,getChatGroups:e.getChatGroups,getChatGroupInfo:e.getChatGroupInfo,createChatGroup:e.createChatGroup,inviteGroupMember:e.inviteGroupMember,modifyChatGroupInfo:e.modifyChatGroupInfo,kickGroupMember:e.kickGroupMember,exitChatGroup:e.exitChatGroup,collectChatGroup:e.collectChatGroup,transferChatGroup:e.transferChatGroup,dismissChatGroup:e.dismissChatGroup,getGroupSharedFiles:e.getGroupSharedFiles,
getGroupMembers:g.getGroupMembers,getPubAccountItems:h.getPubAccountItems,queryPubaccount:h.queryPubaccount,fullSyncRoster:n.fullSyncRoster,deltaSyncRoster:n.deltaSyncRoster,fullSyncChatGroup:n.fullSyncChatGroup,deltaSyncChatGroup:n.deltaSyncChatGroup}}(),B=function(){function a(d,l){if(!0!==p.get(d.id)&&(p.add(d.id,!0),d.from!==k.getInstance().getUserFullJID())){var g;try{g=JSON.parse(d.content)}catch(h){g=d.content}var n={content:g.content,contentType:d.contentType,dateline:d.dateline,extend:g.extend},
q="groupchat"!=l?f.getID(d.from):{room:f.getID(d.from),roster:f.getID(f.getResource(d.from))},q={id:d.id,type:l,from:q,data:n};"chat"==l?(q.resource=f.getResource(d.from),q.to=f.getID(d.receiver||d.to)):q.to=k.getInstance().getUserID();if(!0===d.receipts){var K={to:d.from,id:d.id};!0===m.RECEIPTSPACKET_AUTO?(c(K),e(K)):n.receipt=K}if(n.contentType)switch(n.contentType){case t.TEXT:g.style&&(q.data.style=g.style);try{k.getInstance().onTextMessage(q)}catch(r){YYIMChat.log("textMessHandleError:",0,q)}break;
case t.IMAGE:q.data&&q.data.content&&q.data.content.path&&(q.data.content.attachId=q.data.content.path,q.data.content.path=YYIMChat.getFileUrl(q.data.content.path));try{k.getInstance().onPictureMessage(q)}catch(u){YYIMChat.log("imageMessHandleError:",0,q)}break;case t.FILE:q.data&&q.data.content&&q.data.content.path&&(q.data.content.attachId=q.data.content.path,q.data.content.path=YYIMChat.getFileUrl(q.data.content.path));try{k.getInstance().onFileMessage(q)}catch(v){YYIMChat.log("fileMessHandleError:",
0,q)}break;case t.SHARE:try{k.getInstance().onShareMessage(q)}catch(w){YYIMChat.log("shareMessHandleError:",0,q)}break;case t.SYSTEM:q.data.content=g;q.data&&q.data.content&&q.data.content.path&&(q.data.content.attachId=q.data.content.path,q.data.content.path=YYIMChat.getFileUrl(q.data.content.path));try{k.getInstance().onSystemMessage(q)}catch(x){YYIMChat.log("systemMessHandleError:",0,q)}break;case t.PUBLIC:!g.content&&g.length&&(q.data.content=g);try{k.getInstance().onPublicMessage(q)}catch(y){YYIMChat.log("publicMessHandleError:",
0,q)}break;case t.AUDO:q.data&&q.data.content&&q.data.content.path&&(q.data.content.attachId=q.data.content.path,q.data.content.path=YYIMChat.getFileUrl(q.data.content.path));try{k.getInstance().onAudoMessage(q)}catch(z){YYIMChat.log("AudoMessHandleError:",0,q)}break;case t.LOCATION:q.data&&q.data.content&&q.data.content.path&&(q.data.content.attachId=q.data.content.path,q.data.content.path=YYIMChat.getFileUrl(q.data.content.path));try{k.getInstance().onLocationMessage(q)}catch(A){YYIMChat.log("LocationMessHandleError:",
0,q)}break;case t.WHITEBOARD:try{k.getInstance().onWhiteBoardMessage(q)}catch(B){YYIMChat.log("WhiteBoardMessHandleError:",0,q)}break;default:YYIMChat.log("unhandlePacketError:",0,q)}}}function c(a){a=new JumpPacket({to:f.buildUserJID(f.getNode(a.to),k.getInstance().getUserResource()),dateline:(new Date).getTime(),id:a.id},OPCODE.RECEIPTS.SEND);d.getInstance().send(a)}function e(a){a=new JumpPacket({to:f.buildUserJID(f.getNode(a.to),k.getInstance().getUserResource()),dateline:(new Date).getTime(),
id:a.id,state:2},OPCODE.RECEIPTS.SEND);d.getInstance().send(a)}function g(a,c){if(m.RECEIPTSPACKET_AUTO){var d=m.SERVLET.REST_VERSION_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/"+c.id+"/ack?oldversion="+c.version+"&version="+a.version+"&resource="+m.RESOURCE+"&token="+k.getInstance().getToken();jQuery.ajax({url:d,dataType:"json",type:"put",cache:!1,statusCode:{200:function(){k.getInstance().log("getVersion_sucess:",3,a.version)}}})}}function h(a){a.start||(a.start=0);a.size||(a.size=
100);a.version||(a.version=-1);jQuery.ajax({url:m.SERVLET.REST_VERSION_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/"+a.id+"?version="+a.version+"&start="+a.start+"&size="+a.size+"&resource="+m.RESOURCE+"&token="+k.getInstance().getToken(),dataType:"json",cache:!1,success:function(c){a.complete&&a.complete();if(c.packets&&c.packets.length){for(var d in c.packets)try{for(var l=c.packets[d],e=b64decode(l.opcode),f="0x",g=0;g<e.length;g++)var s=e[g].charCodeAt().toString(16),f=f+(1==
s.length?"0"+s:s);var k=JSON.parse(l.body);k.opcode=f;r.unshift(k)}catch(L){}r.sort(YYIMUtil.array.comparisonAsc("dateline"));c.packets.length>=c.size?(a.start+=a.size,h(a)):n(c,a)}else c.packets&&c.packets.length||n(c,a)},error:function(c){k.getInstance().log("getOfflineMessage_error:",0,c.statusText);a.error&&a.error()}})}function n(c,d){if(r.length){for(var e in r)switch(r[e].opcode){case "0x"+OPCODE.PRESENCE.SEND.toString(16):k.getInstance().onSubscribe({from:f.getID(r[e].from),type:r[e].type});
break;case "0x"+OPCODE.USER_MESSAGE.SEND.toString(16):case "0x"+OPCODE.CHATGROUP_MESSAGE.SEND.toString(16):case "0x"+OPCODE.PUBACCOUNT_MESSAGE.SEND.toString(16):a(r[e],r[e].type);break;default:k.getInstance().log("unHandle_Packet:",3,r[e])}d.version=c.version-r.length;r=[];d.success&&d.success();g(c,d)}}var p=new SNSBaseList,r=[];return{monitor:function(){var c=d.getInstance();c.registerHandler(OPCODE.USER_MESSAGE.KEY,function(c){a(c,c.type)});c.registerHandler(OPCODE.CHATGROUP_MESSAGE.KEY,function(c){a(c,
c.type)});c.registerHandler(OPCODE.PUBACCOUNT_MESSAGE.KEY,function(c){a(c,c.type)});c.registerHandler(OPCODE.RECEIPTS.KEY,function(a){a.from=f.getID(a.from);a.to=f.getID(a.to);k.getInstance().onReceipts(a)});c.registerHandler(OPCODE.SYNC_MESSAGE.KEY,function(c){a(c,c.type)})},sendMessage:function(a){var c,l=a.body||{},e={id:a.id,type:a.type||"chat",contentType:l.contentType||t.TEXT,dateline:l.dateline,content:{extend:l.extend,content:l.content}},g=OPCODE.USER_MESSAGE.SEND;"groupchat"==a.type?(c=f.buildChatGroupJID(f.getNode(a.to)),
...
null;g.body=s;e.body.contentType=c.result[l].contentType;e.body.dateline=c.result[l].dateline||c.result[l].ts;e.body.content&&e.body.contentType&&(e.body.contentType==t.IMAGE||e.body.contentType==t.FILE)&&(e.body.content.path=e.body.content.path?YYIMChat.getFileUrl(e.body.content.path):null);d.push(e)}}YYIMCommonUtil.isFunction(a.success)&&a.success({count:Number(c.count),result:d})},error:function(c){a.error&&a.error();k.getInstance().log("getHistoryMessage_error:",0,c.statusText)},complete:function(){a.complete&&
a.complete()}})},getOfflineMessage:h,sendReceiptsPacket:c,sendReadedReceiptsPacket:e}}(),p=function(){return{monitor:function(){var a=d.getInstance();a.registerHandler(OPCODE.PRESENCE.KEY,function(a){if(a.type&&"unavailable"!=a.type)k.getInstance().onSubscribe({from:f.getID(a.from),type:a.type});else{var c={from:f.getID(a.from),resource:f.getResource(a.from),type:a.type,show:a.show,status:a.status};A.getInstance().addToOnline(c.from);a.type&&"unavailable"==a.type&&(c.show=y.UNAVAILABLE,c.status=y.UNAVAILABLE,
A.getInstance().removeFromOnline(c.from));YYIMCommonUtil.isStringAndNotEmpty(c.status)||(c.show=y.CHAT,c.status=y.CHAT);k.getInstance().onPresence(c)}});a.registerHandler(OPCODE.CHATGROUP.KEY,function(a){if("unavailable"==a.type)k.getInstance().onRoomMemerPresence({room:f.getID(a.from),member:{id:f.getID(a.jid)},type:"quit"});else k.getInstance().onRoomMemerPresence({room:f.getID(a.from),member:{id:f.getID(a.jid),nick:a.name?a.name:f.getID(a.jid),affiliation:a.affiliation,role:a.role},type:"join"})})},
...
(c.priority=a.priority);YYIMCommonUtil.isStringAndNotEmpty(a.type)&&(c.type=a.type);d.getInstance().send(new JumpPacket(c,OPCODE.PRESENCE.SEND))},addPubAccount:function(a){d.getInstance().send(new JumpPacket({type:"subscribe",to:a.jid},OPCODE.PRESENCE.SEND),function(a,c){c.complete&&c.complete();a.from=f.getID(a.from);a.to=f.getID(a.to);c.success&&c.success(a)},a)},removePubAccount:function(a){d.getInstance().send(new JumpPacket({id:a.id,type:"unsubscribe",to:a.to},OPCODE.PRESENCE.SEND),function(a,
c){c.complete&&c.complete();a.from=f.getID(a.from);a.to=f.getID(a.to)||k.getInstance().getUserID();c.success&&c.success(a)},a)},joinChatGroup:function(a){var c={to:a.jid+"/"+k.getInstance().getUserNode()};d.getInstance().send(new JumpPacket(c,OPCODE.CHATGROUP.SEND),function(c,d){a.complete&&a.complete();a.success&&a.success({id:f.getID(c.from),affiliation:c.affiliation,role:c.role})},a)},delGroupMember:function(a,c,e){var f=parseInt(1E5+1E5*Math.random());0<c.indexOf("@")&&(c=c.split("@")[0]);d.getInstance().send(new JumpPacket({id:f,
to:a,member:c,role:"none"},OPCODE.DEL_GROUPMEMBER.SEND),function(a){e&&e(a)})},quitChatGroup:function(a){d.getInstance().send(new JumpPacket({type:"unavailable",to:a+"/"+k.getInstance().getUserNode()},OPCODE.CHATGROUP.SEND),function(){})}}}(),E=function(){return{monitor:function(){d.getInstance().registerHandler(OPCODE.UPDATE_WHITEBOARD.KEY,function(a){a.from=f.getID(a.from);k.getInstance().onWhiteBoardUpdated(a)})},operateWhiteBoard:function(a){d.getInstance().send(new JumpPacket({id:a.id,wid:a.wid,
name:a.name,origin:f.buildUserJID(f.getNode(a.origin)),operation:a.operation},OPCODE.OPERATE_WHITEBOARD.SEND),function(a,c){c.complete&&c.complete();a.from&&(a.from=f.getID(a.from));a.to&&(a.to=f.getID(a.to));c.success&&c.success(a)},a)},listenWhiteBoard:function(a){d.getInstance().send(new JumpPacket({id:a.id,wid:a.wid,operation:a.operation},OPCODE.LISTEN_WHITEBOARD.SEND),function(a,c){c.complete&&c.complete();a.from&&(a.from=f.getID(a.from));a.to&&(a.to=f.getID(a.to));c.success&&c.success(a)},a)},
updateWhiteBoard:function(a){var c={id:a.id,from:a.from,wid:a.wid,nodeId:a.nodeId,nodeContent:a.nodeContent,nodeText:a.nodeText,operation:a.operation};d.getInstance().send(new JumpPacket(c,OPCODE.UPDATE_WHITEBOARD.SEND),function(a,c){c.complete&&c.complete();a.from&&(a.from=f.getID(a.from));c.success&&c.success(a)},a)}}}();a.prototype.startPing=function(){d.getInstance().connected()&&(this.pingInterval=setInterval(this.ping.bind(this),m.PING.INTERVAL))};a.prototype.stopPing=function(){clearTimeout(this.pingTimeout);
clearInterval(this.pingInterval)};a.prototype.ping=function(){if(!((new Date).getTime()-this.lastPongTime<m.PING.DURATION)){var a=new JumpPacket(null,OPCODE.PING.SEND);try{d.getInstance().send(a),this.pingTimeout=setTimeout(this.timeoutHandler.bind(this),m.PING.TIMEOUT)}catch(c){F.log("SNSConnectService.ping",0,c),this.stopPing(),k.getInstance().onConnectError({errorCode:408,message:"\u8fde\u63a5\u5931\u8d25"})}}};a.prototype.pong=function(){this.lastPongTime=(new Date).getTime();clearTimeout(this.pingTimeout)};
a.prototype.timeoutHandler=function(){this.stopPing();k.getInstance().onConnectError({errorCode:408,message:"\u8fde\u63a5\u5931\u8d25"})};c.prototype._init=function(){F.log("YYIMConnectEventHandler.prototype.registerHandler",3);if(!this._inited){var a=d.getInstance();a.registerHandler("onConnect",this.onConnected);a.registerHandler("onDisconnect",this.onDisConnect);a.registerHandler("onStatusChanged",this.connectStatusChangeHandler);a.registerHandler(OPCODE.STREAM_ERROR.KEY,this.onStreamError);a.registerHandler(OPCODE.PACKET_ERROR.KEY,
this.onPacketError);this._inited=!0}};c.prototype.onConnected=function(){k.getInstance().onOpened();d.getInstance().getDaemon().startPing()};c.prototype.onConnectError=function(a){F.log("YYIMConnectEventHandler.prototype.onConnectError ",0,a);errorCode=a.getAttribute("code");d.getInstance().getDaemon().stopPing();if(401==errorCode||401==errorCode/10)k.getInstance().onAuthError({errorCode:401,message:"\u7528\u6237\u540d\u6216\u5bc6\u7801\u9519\u8bef"});else k.getInstance().onConnectError({errorCode:errorCode,
message:"\u8fde\u63a5\u5931\u8d25"})};c.prototype.onStreamError=function(a){F.log("YYIMConnectEventHandler.prototype.onPacketError ",0,a);d.getInstance().getDaemon().stopPing();if(401==a.code||401==a.code/10)k.getInstance().onAuthError({errorCode:401,message:"\u7528\u6237\u540d\u6216\u5bc6\u7801\u9519\u8bef"});else k.getInstance().onConnectError({errorCode:a.code,message:a.message})};c.prototype.onPacketError=function(a){F.log("YYIMConnectEventHandler.prototype.onPacketError ",0,a)};c.prototype.onDisConnect=
function(){k.getInstance().onClosed();d.getInstance().getDaemon().stopPing()};c.prototype.connectStatusChangeHandler=function(a){F.log("connectStatusChangeHandler",3,a);k.getInstance().onStatusChanged(a)};d.getInstance=function(){d._instance||(d._instance=new d,d._instance._init());return d._instance};d.prototype.getDaemon=function(){return this.daemon};d.prototype._init=function(){p.monitor();B.monitor();v.monitor();E.monitor();this.eventHandler._init();this.registerHandler(OPCODE.AUTH.KEY,function(a){var c=
new JSJaCJID(a.jid);a=f.getID(a.jid);k.getInstance()._user={jid:c,name:a};k.getInstance().onUserBind(a,c.getResource())});this.registerHandler(OPCODE.PING.KEY,this.getDaemon().pong.bind(this.getDaemon()))};d.prototype.registerHandler=function(a,c,d,e){if(this.connection)this.connection.registerHandler.apply(this.connection,arguments);else throw"connection is undefined!";};d.prototype.connected=function(){return this.connection&&this.connection.connected()?!0:!1};d.prototype.getConnection=function(){this.connection||
(m.useWebSocket()?this.connection=new JSJaCWebSocketConnection({httpbase:m.getWebSocketUrl()}):this.connection=new JSJaCHttpBindingConnection({httpbase:m.getHttpBindUrl(),timerval:m.CONNECTION.TIMERVAL,wait:m.CONNECTION.WAIT}));return this.connection};d.prototype.connect=function(a,c,d){this.connectArg||(this.connectArg=m.getConnectionArgObj());a&&(this.connectArg.username=a,this.connectArg.password=c);k.getInstance()._user={jid:new JSJaCJID(this.connectArg.username+"@"+g+"/"+this.connectArg.resource),
name:this.connectArg.username};this.connection.connect(this.connectArg)};d.prototype.disconnect=function(){this.daemon.stopPing();this.connection&&this.connection.disconnect()};d.prototype.send=function(a,c,d,e){this.waitingList.push({packet:a,callback:c,data:d,callbackContext:e});this.sending||this.sendInterval()};d.prototype.sendInterval=function(){var a=this;if(this.waitingList.length){this.sending=!0;var c=this.waitingList[0],d=(new Date).getTime()-this.lastSendTime;d>=m.SENDINTERVAL?(this.sendJumpPacket(c),
this.waitingList.shift(),this.lastSendTime=(new Date).getTime(),this.sendInterval()):setTimeout(function(){a.sendJumpPacket(c);a.waitingList.shift();a.lastSendTime=(new Date).getTime();a.sendInterval()},m.SENDINTERVAL-d)}else this.sending=!1};d.prototype.sendJumpPacket=function(a){return a.callbackContext?this.connection.sendJumpPacket(a.packet,a.callback.bind(a.callbackContext),a.data):this.connection.sendJumpPacket(a.packet,a.callback,a.data)};e.prototype.get=function(){var a=this.xhr;a.open("GET",
this.url,!0);e.prototype._listenFn.call(this);a.send()};e.prototype.post=function(){var a=this.xhr;a.open("POST",this.url,!0);e.prototype._listenFn.call(this);a.setRequestHeader("Content-Type","x-www-form-urlencoded");a.send(this.data)};e.prototype.isLoop=function(a){this.loop=a};e.prototype.stopLoop=function(){clearTimeout(_self.timeoutIndex)};e.prototype._listenFn=function(){var a=this,c=this.xhr;this.timeoutIndex=setTimeout(function(){a.loop&&e.prototype.get.call(a);a.eCallback(c.responseText)},
a.timeout);c.onreadystatechange=function(){4==c.readyState&&(clearTimeout(a.timeoutIndex),200==c.status?a.sCallback(c.responseText):a.eCallback(c.responseText))}};var I=function(){return{multiPartyCall:function(a){if(!0===a.accountMmanaged){var c={etpId:m.MULTI_TENANCY.ETP_KEY,appId:m.MULTI_TENANCY.APP_KEY,caller:a.caller,phones:a.phones,username:k.getInstance().getUserNode()};jQuery.ajax({url:m.MULTIPARTYCALL.RESTADDRESS+"?token="+k.getInstance().getToken(),type:"post",data:JSON.stringify(c),dataType:"json",
cache:!1,processData:!1,contentType:"application/json",headers:{},success:function(c){a.success&&a.success(c)},error:function(c){a.error&&a.error()}})}else c=(new Date).getTime(),c={caller:a.caller,phones:a.phones,account_identify:a.account,userId:k.getInstance().getUserBareJID(),timestamp:c,sign:hex_sha1(a.account+a.key+c)},jQuery.ajax({url:m.MULTIPARTYCALL.ADDRESS,type:"get",data:c,dataType:"jsonp",cache:!1,jsonp:"callback",success:function(c){a.success&&a.success(c)},error:function(c){a.error&&
a.error()}})}}}(),w=function(){this._provider};w.getInstance=function(){w._instance||(w._instance=new w);return w._instance};w.prototype.init=function(a){this._provider=a&&a.provider?a.provider:new H};w.prototype.getProvider=function(){this._provider||(this._provider=new H);return this._provider};w.prototype.getChatGroups=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getChatGroups)&&this.getProvider().getChatGroups(a)};w.prototype.addChatGroup=function(a){p.joinChatGroup({jid:f.buildChatGroupJID(f.getNode(a.node)),
success:function(){v.configChatGroup({jid:this.jid,name:a.name,desc:a.desc,error:a.error,success:function(){a.success&&a.success({name:a.name,node:a.node,id:a.id,nickname:k.getInstance().getUserID()})},complete:a.complete})},error:function(){a.error&&a.error()}});this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().addChatGroup)&&this.getProvider().addChatGroup(a)};w.prototype.createChatGroup=function(a){v.createChatGroup({id:Math.uuid(),name:a.name,members:a.members,success:function(c){a.success&&
a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.transferChatGroup=function(a){v.transferChatGroup({id:Math.uuid(),to:a.to,newOwner:a.newOwner,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.dismissChatGroup=function(a){v.dismissChatGroup({id:Math.uuid(),to:a.to,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.inviteGroupMember=function(a){v.inviteGroupMember({id:Math.uuid(),
to:a.to,members:a.members,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.modifyChatGroupInfo=function(a){v.modifyChatGroupInfo({id:Math.uuid(),to:a.to,name:a.name,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.kickGroupMember=function(a){v.kickGroupMember({id:Math.uuid(),to:a.to,member:a.member,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};
w.prototype.exitChatGroup=function(a){v.exitChatGroup({id:Math.uuid(),to:a.to,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.collectChatGroup=function(a){v.collectChatGroup({id:Math.uuid(),to:a.to,type:a.type,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.delGroupMember=function(a,c,d){p.delGroupMember(a,c,d)};w.prototype.quitChatGroup=function(a){p.quitChatGroup(a);this.getProvider()&&
YYIMCommonUtil.isFunction(this.getProvider().quitChatGroup)&&this.getProvider().quitChatGroup(a)};w.prototype.queryChatGroup=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().queryChatGroup)&&this.getProvider().queryChatGroup(a)};w.prototype.joinChatGroup=function(a){p.joinChatGroup(a)};w.prototype.updateChatGroup=function(a){v.configChatGroup(a)};var H=function(){};H.prototype.getChatGroups=function(a){v.getChatGroups(a)};H.prototype.addChatGroup=function(a){};H.prototype.quitChatGroup=
function(a){};H.prototype.queryChatGroup=function(a){v.queryChatGroup(a)};var D=function(){this._provider};D.getInstance=function(){D._instance||(D._instance=new D);return D._instance};D.prototype.init=function(a){this._provider=a&&a.provider?a.provider:new J};D.prototype.getProvider=function(){this._provider||(this._provider=new J);return this._provider};D.prototype.getGroupMembers=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getGroupMembers)&&this.getProvider().getGroupMembers(a)};
D.prototype.addGroupMember=function(a,c){B.addGroupMember(a,c);this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().addGroupMember)&&this.getProvider().addGroupMember(a,c)};var J=function(){};J.prototype.getGroupMembers=function(a){v.getGroupMembers(a)};J.prototype.addGroupMember=function(a,c){};var A=function(){this._provider;this._onlineList=new SNSBaseList};A.getInstance=function(){A._instance||(A._instance=new A);return A._instance};A.prototype.addToOnline=function(a){this._onlineList.add(a,
!0)};A.prototype.removeFromOnline=function(a){this._onlineList.remove(a)};A.prototype.init=function(a){this._provider=a&&a.provider?a.provider:new G};A.prototype.getProvider=function(){this._provider||(this._provider=new G);return this._provider};A.prototype.getRosterItems=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getRosterItems)&&this.getProvider().getRosterItems(a)};A.prototype.addRosterItem=function(a){p.addRosterItem(a);this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().addRosterItem)&&
this.getProvider().addRosterItem(a)};A.prototype.deleteRosterItem=function(a){v.deleteRosterItem(a);this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().deleteRosterItem)&&this.getProvider().deleteRosterItem(a)};A.prototype.queryRosterItem=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().queryRosterItem)&&this.getProvider().queryRosterItem(a)};A.prototype.getRostersPresence=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getRostersPresence)&&
this.getProvider().getRostersPresence(a)};var G=function(){};G.prototype.getRosterItems=function(a){v.getRosterItems(a)};G.prototype.addRosterItem=function(a){};G.prototype.deleteRosterItem=function(a){};G.prototype.queryRosterItem=function(a){v.queryRosterItem(a)};G.prototype.getRostersPresence=function(a){v.getRostersPresence(a)};var z=function(){},F=new function(a){this.level=a?a:0==a?0:3;this.start=function(){};this.log=function(a,c,d,e){if(m.LOG.ENABLE&&(c=c?c:0==c?0:3,!(c>this.level)&&"undefined"!=
typeof console&&"undefined"!=typeof console.group))try{console.group(a);switch(c){case 0:console.error(a);console.trace();break;case 1:console.warn(a);console.trace();break;case 2:console.info(a);break;case 4:console.debug(a);break;default:console.log(a)}var l=arguments.length;if(2<l)for(var f=2;f<l;f++){var g=arguments[f];g&&(g instanceof JSJaCPacket?console.info(g.doc.xml):console.debug(g))}console.groupEnd()}catch(h){try{console.error(h)}catch(k){}}};this.logParam=function(a){this.log("arguments:",
a||3,this.logParam.caller.arguments)};this.setLevel=function(a){this.level=a;return this};this.getLevel=function(){return this.level}}(m.LOG.FILTER_LEVEL),k=function(){this._user;this.init();this._token={};this._anonymousUser=!1;this.appkey;this.version="2.0"};k.getInstance=function(){k._instance||(k._instance=new k);return k._instance};k.prototype.log=function(a,c,d,e){F.log(a,c,d,e)};k.prototype.init=function(a){a=a||{};this.onOpened=a.onOpened||z;this.onClosed=a.onClosed||z;this.onAuthError=a.onAuthError||
z;this.onStatusChanged=a.onStatusChanged||z;this.onConnectError=a.onConnectError||z;this.onUserBind=a.onUserBind||z;this.onPresence=a.onPresence||z;this.onSubscribe=a.onSubscribe||z;this.onRosterDeleted=a.onRosterDeleted||z;this.onRosterUpdateded=a.onRosterUpdateded||z;this.onGroupUpdate=a.onGroupUpdate||z;this.onTransferGroupOwner=a.onTransferGroupOwner||z;this.onKickedOutGroup=a.onKickedOutGroup||z;this.onPubaccountUpdate=a.onPubaccountUpdate||z;this.onRoomMemerPresence=a.onRoomMemerPresence||z;
this.onMessage=a.onMessage||z;this.onReceipts=a.onReceipts||z;this.onTextMessage=a.onTextMessage||z;this.onPictureMessage=a.onPictureMessage||z;this.onFileMessage=a.onFileMessage||z;this.onShareMessage=a.onShareMessage||z;this.onSystemMessage=a.onSystemMessage||z;this.onPublicMessage=a.onPublicMessage||z;this.onDeviceMessage=a.onDeviceMessage||z;this.onAudoMessage=a.onAudoMessage||z;this.onLocationMessage=a.onLocationMessage||z;this.onWhiteBoardMessage=a.onWhiteBoardMessage||z;this.onWhiteBoardUpdated=
a.onWhiteBoardUpdated||z};k.prototype.initUpload=function(){if(arguments&&SNSIMUploadUseFlash&&"function"==typeof SNSIMUploadUseFlash.prototype.addUploader)for(var a=0;a<arguments.length;a++){var c=arguments[a];"string"==typeof c.button_placeholder_id&&SNSIMUploadUseFlash.getInstance().addUploader(c)}};k.prototype.initSDK=function(a,c,d){var e=m.MULTI_TENANCY;e.ENABLE=!0;e.APP_KEY=a;e.ETP_KEY=c;this.appkey=e.SEPARATOR+e.APP_KEY+e.SEPARATOR+e.ETP_KEY;d&&(h=d.address||h,m.CONNECTION.HTTP_BASE=h,n=d.wsport||
n,m.CONNECTION.WS_PORT=n,u=d.hbport||u,m.CONNECTION.HTTP_BIND_PORT=u,x=d.servlet||x,m.SERVLET={FILE_UPLOAD_SERVLET:x+"fileUpload",FILE_DOWNLOAD_SERVLET:x+"download",FILE_DELETE_SERVLET:x+"cancel",AVATAR_SERVLET:x+"avatar",REST_RESOURCE_SERVLET:x+"rest/resource/",REST_HISTORY_SERVLET:x+"rest/history/",REST_VERSION_SERVLET:x+"rest/version/",REST_USER_SERVLET:x+"rest/user/"})};k.prototype.getTenancy=function(){return m.MULTI_TENANCY};k.prototype.getAppkey=function(){return this.appkey};k.prototype.setRosterProvider=
function(a){A.getInstance().init({provider:a||new G})};k.prototype.setChatGroupProvider=function(a){w.getInstance().init({provider:a||new H})};k.prototype.setChatGroupMemberProvider=function(a){D.getInstance().init({provider:a||new J})};k.prototype.setServer=function(a,c){m.CONNECTION.SERVER_NAME=a;m.CONNECTION.HTTP_BASE=c?c:a};k.prototype.disConnect=function(){d.getInstance().disconnect()};k.prototype.connect=function(){d.getInstance().connect()};k.prototype.getToken=function(){return this._token.token};
k.prototype.getTokenExpiration=function(){return this._token.expiration};k.prototype.login=function(a,c,e){this._token={token:c,expiration:e};!YYIMCommonUtil.isStringAndNotEmpty(a)&&m.IS_ANONYMOUS&&(this._anonymousUser=!0);!this.isAnonymous()&&m.MULTI_TENANCY.ENABLE&&(a=f.getNode(a));d.getInstance().connect(a,c)};k.prototype.logout=function(){d.getInstance().disconnect()};k.prototype.getUserBareJID=function(){return this._user.jid.getBareJID()};k.prototype.getUserFullJID=function(){return this._user.jid.toString()};
k.prototype.getUserNode=function(){return f.getNode(this.getUserBareJID())};k.prototype.getUserID=function(){return f.getID(this.getUserBareJID())};k.prototype.getUserResource=function(){return m.RESOURCE};k.prototype.fullSyncRoster=function(a){if(YYIMArrayUtil.isArray(a)){for(var c=a.length,d=[];c--;)YYIMCommonUtil.isStringAndNotEmpty(a[c].id)&&d.push({jid:f.buildUserJID(f.getNode(a[c].id)),name:a[c].name?a[c].name:a[c].id});v.fullSyncRoster(d)}};k.prototype.deltaSyncRoster=function(a,c){var d=-2,
e=-2,g=[],h=[];if(YYIMArrayUtil.isArray(a))for(d=a.length;d--;)YYIMCommonUtil.isStringAndNotEmpty(a[d])&&g.push(f.buildUserJID(f.getNode(a[d])));if(YYIMArrayUtil.isArray(c))for(e=c.length;e--;)YYIMCommonUtil.isStringAndNotEmpty(c[e].id)&&h.push({jid:f.buildUserJID(f.getNode(c[e].id)),name:c[e].name?c[e].name:c[e].id});-2===d&&-2===e||v.deltaSyncRoster(g,h)};k.prototype.fullSyncChatGroup=function(a){if(YYIMArrayUtil.isArray(a)){for(var c=a.length,d=[];c--;)YYIMCommonUtil.isStringAndNotEmpty(a[c].id)&&
d.push({id:f.getID(a[c].id),name:a[c].name?a[c].name:a[c].id});v.fullSyncChatGroup(d)}};k.prototype.deltaSyncChatGroup=function(a,c){var d=-2,e=-2,g=[],h=[];if(YYIMArrayUtil.isArray(a))for(d=a.length;d--;)YYIMCommonUtil.isStringAndNotEmpty(a[d])&&g.push(f.getID(a[d]));if(YYIMArrayUtil.isArray(c))for(e=c.length;e--;)YYIMCommonUtil.isStringAndNotEmpty(c[e].id)&&h.push({id:f.getID(c[e].id),name:c[e].name?c[e].name:c[e].id});-2===d&&-2===e||v.deltaSyncChatGroup(g,h)};k.prototype.setPresence=function(a){var c=
{};if(a){if(a.show)for(var d in y)if(y[d]===a.show){c.show=y[d];break}if(!c.show&&a.status)for(d in y)if(y[d]===a.status){c.show=y[d];break}c.status=a.status}c.show=c.show?c.show:y.AVAILABLE;p.setPresence(c)};k.prototype.getVCard=function(a){var c={success:a.success,error:a.error,complete:a.complete};YYIMCommonUtil.isStringAndNotEmpty(a.id)&&(c.jid=f.buildUserJID(f.getNode(a.id)));v.getVCard(c)};k.prototype.getVCards=function(a){v.getVCards({success:a.success,error:a.error,complete:a.complete})};
k.prototype.setVCard=function(a){v.setVCard({vcard:{nickname:a.vcard.nickname,photo:a.vcard.photo,email:a.vcard.email,mobile:a.vcard.mobile,telephone:a.vcard.telephone},success:a.success,error:a.error})};k.prototype.getRosterItems=function(a){A.getInstance().getRosterItems(a)};k.prototype.addRosterItem=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&A.getInstance().addRosterItem(f.buildUserJID(f.getNode(a)))};k.prototype.approveSubscribe=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&p.approveSubscribe(f.buildUserJID(f.getNode(a)))};
k.prototype.rejectSubscribe=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&p.rejectSubscribe(f.buildUserJID(f.getNode(a)))};k.prototype.deleteRosterItem=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&A.getInstance().deleteRosterItem({jid:f.buildUserJID(f.getNode(a.id)),success:a.success,error:a.error,complete:a.complete})};k.prototype.queryRosterItem=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.keyword)&&A.getInstance().queryRosterItem(a)};k.prototype.getRostersPresence=function(a){a.username instanceof
Array&&(a.username=JSON.stringify(a.username),A.getInstance().getRostersPresence(a))};k.prototype.updateRosterItem=function(a){a&&a.roster&&YYIMCommonUtil.isStringAndNotEmpty(a.roster.id)&&v.updateRosterItem({roster:{jid:f.buildUserJID(f.getNode(a.roster.id)),name:a.roster.name,groups:a.roster.groups},success:a.success,error:a.error})};k.prototype.queryChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.keyword)&&w.getInstance().queryChatGroup(a)};k.prototype.quitChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&
w.getInstance().quitChatGroup(f.buildChatGroupJID(f.getNode(a)))};k.prototype.delGroupMember=function(a,c,d){YYIMCommonUtil.isStringAndNotEmpty(c)&&w.getInstance().delGroupMember(f.buildChatGroupJID(f.getNode(a)),f.buildUserJID(f.getNode(c)),d)};k.prototype.joinChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&w.getInstance().joinChatGroup({jid:f.buildChatGroupJID(f.getNode(a.id)),success:a.success,error:a.error})};k.prototype.getChatGroupInfo=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&
v.getChatGroupInfo({jid:f.buildChatGroupJID(f.getNode(a.id)),success:a.success,error:a.error})};k.prototype.getPubAccount=function(a){v.getPubAccountItems(a)};k.prototype.addPubaccount=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)?p.addPubAccount({jid:f.buildPubAccountJID(f.getNode(a.id)),success:a.success,error:a.error}):a.error&&a.error()};k.prototype.removePubaccount=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)?p.removePubAccount({id:Math.uuid(),to:f.buildPubAccountJID(f.getNode(a.id)),
success:a.success,error:a.error}):a.error&&a.error()};k.prototype.queryPubaccount=function(a){v.queryPubaccount(a)};k.prototype.getChatGroups=function(a){w.getInstance().getChatGroups(a)};k.prototype.addGroupMember=function(a){if(YYIMCommonUtil.isStringAndNotEmpty(a.roomId)&&YYIMArrayUtil.isArray(a.ids)){var c=f.buildChatGroupJID(f.getNode(a.roomId));a=a.ids.slice();for(var d=0,e=a.length;d<e;d++)a[d]=f.buildUserJID(f.getNode(a[d]));D.getInstance().addGroupMember(c,a)}};k.prototype.addChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.node)&&
w.getInstance().addChatGroup(a)};k.prototype.createChatGroup=function(a){a.members instanceof Array||delete a.members;a.name?w.getInstance().createChatGroup(a):a.error&&a.error()};k.prototype.transferChatGroup=function(a){a&&"string"==typeof a.newOwner&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),w.getInstance().transferChatGroup(a)):a.error&&a.error()};k.prototype.dismissChatGroup=function(a){a&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),w.getInstance().dismissChatGroup(a)):a.error&&a.error()};
k.prototype.getGroupSharedFiles=function(a){a&&a.id&&v.getGroupSharedFiles(a)};k.prototype.inviteGroupMember=function(a){a.members&&a.members instanceof Array&&a.members.length&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),w.getInstance().inviteGroupMember(a)):a.error&&a.error()};k.prototype.modifyChatGroupInfo=function(a){a.name&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),w.getInstance().modifyChatGroupInfo(a)):a.error&&a.error()};k.prototype.kickGroupMember=function(a){a.member&&"string"==
typeof a.member&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),w.getInstance().kickGroupMember(a)):a.error&&a.error()};k.prototype.exitChatGroup=function(a){a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),w.getInstance().exitChatGroup(a)):a.error&&a.error()};k.prototype.collectGroup=function(a){a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),a.type="add",w.getInstance().collectChatGroup(a)):a.error&&a.error()};k.prototype.removeCollectGroup=function(a){a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),
a.type="remove",w.getInstance().collectChatGroup(a)):a.error&&a.error()};k.prototype.updateChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&w.getInstance().updateChatGroup({jid:f.buildChatGroupJID(f.getNode(a.id)),name:a.name,desc:a.desc,photo:a.photo,error:a.error,success:a.success,complete:a.complete})};k.prototype.getGroupMembers=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&D.getInstance().getGroupMembers({jid:f.buildChatGroupJID(f.getNode(a.id)),success:a.success,error:a.error,
complete:a.complete})};k.prototype.getHistoryMessage=function(a){if(!a.start||isNaN(a.start))a.start=0;if(!a.num||isNaN(a.num))a.num=100;B.getHistoryMessage(a)};k.prototype.getOfflineMessage=function(){B.getOfflineMessage({id:this.getUserID()})};k.prototype.sendReceiptsPacket=function(a){B.sendReceiptsPacket(a)};k.prototype.sendReadedReceiptsPacket=function(a){B.sendReadedReceiptsPacket(a)};k.prototype.sendMessage=function(a){B.sendMessage(a)};k.prototype.sendAccessoryMessage=function(a){a.id=Math.uuid();
var c=new SNSFile(a.body.content.name,a.body.content.attachId,a.body.content.size);a.body={content:c,contentType:a.contentType||t.FILE,dateline:(new Date).getTime()};YYIMChat.sendMessage(a)};k.prototype.sendFormMessage=function(a){var c={token:this.getToken(),creator:this.getUserID()+"."+m.MULTI_TENANCY.APP_KEY+"."+m.MULTI_TENANCY.ETP_KEY,receiver:a.to+"."+m.MULTI_TENANCY.APP_KEY+"."+m.MULTI_TENANCY.ETP_KEY,mediaType:a.mediaType||2,randomId:Math.uuid(),name:a.file.name,size:a.file.size},d=m.SERVLET.REST_RESOURCE_SERVLET+
m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/upload",d=d+("?"+jQuery.param(c));jQuery.ajax({url:d,type:"post",dataType:"json",data:a.data,processData:!1,contentType:!1,success:function(d){d&&d.attachId?(d={to:a.to,body:{content:{name:a.file.name,size:a.file.size,attachId:d.attachId}},type:a.type,success:function(c){var d={name:c.body.content.name,size:c.body.content.size,type:c.body.content.type,path:YYIMChat.getFileUrl(c.body.content.path)};c.body.content=d;c.to=YYIMChat.getJIDUtil(c.to);
a.success&&a.success(c)}},d.contentType=1===c.mediaType?t.IMAGE:t.FILE,k.getInstance().sendAccessoryMessage(d)):a.error&&a.error()},error:function(c,d){a.error&&a.error()},complete:function(c,d){a.complete&&a.complete()}})};k.prototype.sendShareMessage=function(a){a.content=a.sharebody||a.content;a.contentType=t.SHARE;this.postMessage(a)};k.prototype.sendWhiteBoardMessage=function(a){a.contentType=t.WHITEBOARD;this.postMessage(a)};k.prototype.sendTextMessage=function(a){a.content=a.msg||a.content;
a.contentType=t.TEXT;this.postMessage(a)};k.prototype.postMessage=function(a){a.id=Math.uuid();a.body={extend:a.extend,content:a.content,contentType:a.contentType,dateline:(new Date).getTime()};a.style&&"string"!=typeof a.style&&(a.body.style=JSON.stringify(a.style));this.sendMessage(a)};k.prototype.sendPic=function(a){var c=f.getNode(a.to),c="groupchat"==a.type?f.buildChatGroupJID(c):f.buildUserJID(c),c={fileTypeExts:"jpg;jpeg;png;bmp;gif",fileSizeLimit:5120,breakPoints:!1,saveInfoLocal:!1,removeTimeout:100,
uploader:m.SERVLET.FILE_UPLOAD_SERVLET,uploadIdPrefix:"image_upload_",inputId:a.fileInputId,to:c,type:t.IMAGE,chatType:a.type,onUploadSuccess:a.success,onUploadProgress:a.progress,onUploadError:a.error,showProcess:!1,processId:"udnProcessBar"};a.resource&&(c.resource=a.resource);FileUpload.getInstance(a.fileInputId,c);FileUpload.getInstance(a.fileInputId).sendFile(document.getElementById(a.fileInputId))};k.prototype.sendFile=function(a){var c=f.getNode(a.to),c="groupchat"==a.type?f.buildChatGroupJID(c):
f.buildUserJID(c),c={fileTypeExts:"*",fileSizeLimit:99999999,breakPoints:!0,saveInfoLocal:!0,removeTimeout:100,uploader:m.SERVLET.FILE_UPLOAD_SERVLET,uploadIdPrefix:"bp_upload_",inputId:a.fileInputId,to:c,type:t.FILE,chatType:a.type,onUploadSuccess:a.success,onUploadProgress:a.progress,onUploadError:a.error,showProcess:!0,processId:"udnProcessBar"};a.resource&&(c.resource=a.resource);FileUpload.getInstance(a.fileInputId,c);FileUpload.getInstance(a.fileInputId).sendFile(document.getElementById(a.fileInputId))};
...
k.prototype.getServerName=function(){return m.CONNECTION.SERVER_NAME};k.prototype.getFileUrl=function(a,c){var d,e;this.isAnonymous()?(d=this.getUserFullJID(),e="anonymous"):(d=this.getUserNode(),e=this.getToken());d={token:e,attachId:a,downloader:d};"undefined"!==typeof c&&(d.mediaType=2===c?2:1);e=m.SERVLET.REST_RESOURCE_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/download";return e+="?"+jQuery.param(d)};k.prototype.getServletPath=function(){return m.SERVLET};k.prototype.getJIDUtil=
function(){return f};k.prototype.getArrayUtil=function(){return YYIMArrayUtil};k.prototype.isAnonymous=function(){return this._anonymousUser};k.prototype.enableAnonymous=function(){return m.IS_ANONYMOUS};k.prototype.getBrowser=function(){return m.BROWSER};k.prototype.isOnline=function(a){return!0==A.getInstance()._onlineList.get(a)};k.prototype.multiPartyCall=function(a){if("undefined"===typeof a||"undefined"===typeof a.caller||!a.phones instanceof Array||!a.phones.length)a.error&&a.error();else if(YYIMRegularUtil.phone.test(a.caller)){var c=
...
return}I.multiPartyCall(a)}else a.error&&a.error()}else a.error&&a.error()};k.prototype.operateWhiteBoard=function(a){var c={id:Math.uuid(),origin:a.origin,operation:a.operation||"create",success:a.success,error:a.error,complete:a.complete};"create"!==a.operation&&(c.wid=a.wid);if("create"===a.operation||"rename"===a.operation)c.name=a.name;c.wid&&c.origin&&"listen"===c.operation?E.listenWhiteBoard(c):!c.origin||"create"!==c.operation&&"end"!==c.operation&&"rename"!==c.operation?a.error&&a.error():
E.operateWhiteBoard(c)};k.prototype.updateWhiteBoard=function(a){a.wid&&a.nodeId?(a.id=Math.uuid(),a.from=k.getInstance().getUserFullJID(),a.operation="delete"===a.operation?"delete":"update","update"!=a.operation||a.nodeContent?E.updateWhiteBoard(a):a.error&&a.error()):a.error&&a.error()};return k.getInstance()}();
