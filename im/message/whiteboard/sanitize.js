...
var svgWhiteList_ = {
	...
	"circle": ["class", "clip-path", "clip-rule", "cx", "cy", "fill", "fill-opacity", "fill-rule", "filter", "id", "mask", "opacity", "r", "requiredFeatures", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "style", "systemLanguage", "transform","style"],
	...
	"foreignObject": ["class", "font-size", "height", "id", "opacity", "requiredFeatures", "style","overflow", "transform", "width", "x", "y","fill","data-eletype"],
	"foreignobject": ["class", "font-size", "height", "id", "opacity", "requiredFeatures", "style","overflow", "transform", "width", "x", "y","fill","data-eletype"],
	...
	"rect": ["class", "clip-path", "clip-rule", "fill", "fill-opacity", "fill-rule", "filter", "height", "id", "mask", "opacity", "requiredFeatures", "rx", "ry", "stroke", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "style", "systemLanguage", "transform", "width", "x", "y","baloonType","data-eletype"],
	...
	"textarea": ["class", "id", "style","resizeable","readonly","width","height","font-family","font-size","color","data-eletype","background","border"],
	"div":["data-eletype","class","style"],
	"span":["style","class"],
...
svgedit.sanitize.sanitizeSvg = function(node) {
	...
	if (allowedAttrs != undefined) {
		...
		while (i--) {
			...
			if (attrName == "style"&&!node.tagName=='textarea') {
