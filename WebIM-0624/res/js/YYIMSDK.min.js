...
(function(){function a(a){return 10>a?"0"+a:a}function c(a){f.lastIndex=0;return f.test(a)?'"'+a.replace(f,function(a){var c=n[a];return"string"===typeof c?c:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function d(a,e){var f,n,z,t,v=g,B,q=e[a];q&&"object"===typeof q&&"function"===typeof q.toJSON&&(q=q.toJSON(a));"function"===typeof u&&(q=u.call(e,a,q));switch(typeof q){case "string":return c(q);case "number":return isFinite(q)?String(q):"null";case "boolean":case "null":return String(q);
case "object":if(!q)return"null";g+=h;B=[];if("[object Array]"===Object.prototype.toString.apply(q)){t=q.length;for(f=0;f<t;f+=1)B[f]=d(f,q)||"null";z=0===B.length?"[]":g?"[\n"+g+B.join(",\n"+g)+"\n"+v+"]":"["+B.join(",")+"]";g=v;return z}if(u&&"object"===typeof u)for(t=u.length,f=0;f<t;f+=1)"string"===typeof u[f]&&(n=u[f],(z=d(n,q))&&B.push(c(n)+(g?": ":":")+z));else for(n in q)Object.prototype.hasOwnProperty.call(q,n)&&(z=d(n,q))&&B.push(c(n)+(g?": ":":")+z);z=0===B.length?"{}":g?"{\n"+g+B.join(",\n"+
g)+"\n"+v+"}":"{"+B.join(",")+"}";g=v;return z}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()});var e,f,g,h,n,u;"function"!==typeof JSON.stringify&&(f=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
n={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},JSON.stringify=function(a,c,e){var f;h=g="";if("number"===typeof e)for(f=0;f<e;f+=1)h+=" ";else"string"===typeof e&&(h=e);if((u=c)&&"function"!==typeof c&&("object"!==typeof c||"number"!==typeof c.length))throw Error("JSON.stringify");return d("",{"":a})});"function"!==typeof JSON.parse&&(e=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,JSON.parse=function(a,
...
JSJaCJSON.toString=function(a){var c={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},d={array:function(a){var c=["["],g,h,n,u=a.length,w;for(n=0;n<u;n+=1)if(w=a[n],h=d[typeof w])try{w=h(w),"string"==typeof w&&(g&&(c[c.length]=","),c[c.length]=w,g=!0)}catch(p){}c[c.length]="]";return c.join("")},"boolean":function(a){return String(a)},"null":function(){return"null"},number:function(a){return isFinite(a)?String(a):"null"},object:function(a){if(a){if(a instanceof Array)return d.array(a);
var c=[],g,h,n,u;c.push("{");for(n in a)if(a.hasOwnProperty(n)&&(u=a[n],h=d[typeof u]))try{u=h(u),"string"==typeof u&&(g&&(c[c.length]=","),c.push(d.string(n),":",u),g=!0)}catch(w){}c[c.length]="}";return c.join("")}return"null"},string:function(a){/["\\\x00-\x1f]/.test(a)&&(a=a.replace(/([\x00-\x1f\\"])/g,function(a,d){var e=c[d];if(e)return e;e=d.charCodeAt();return"\\u00"+Math.floor(e/16).toString(16)+(e%16).toString(16)}));return'"'+a+'"'}};switch(typeof a){case "object":return d.object(a);case "array":return d.array(a)}};
...
function binb_sha1(a,c){a[c>>5]|=128<<24-c%32;a[(c+64>>9<<4)+15]=c;for(var d=Array(80),e=1732584193,f=-271733879,g=-1732584194,h=271733878,n=-1009589776,u=0;u<a.length;u+=16){for(var w=e,p=f,C=g,m=h,z=n,t=0;80>t;t++){d[t]=16>t?a[u+t]:bit_rol(d[t-3]^d[t-8]^d[t-14]^d[t-16],1);var v=safe_add(safe_add(bit_rol(e,5),sha1_ft(t,f,g,h)),safe_add(safe_add(n,d[t]),sha1_kt(t))),n=h,h=g,g=bit_rol(f,30),f=e,e=v}e=safe_add(e,w);f=safe_add(f,p);g=safe_add(g,C);h=safe_add(h,m);n=safe_add(n,z)}return[e,f,g,h,n]}
...
function rstr2any(a,c){var d=c.length,e,f,g,h,n,u=Array(Math.ceil(a.length/2));for(e=0;e<u.length;e++)u[e]=a.charCodeAt(2*e)<<8|a.charCodeAt(2*e+1);var w=Math.ceil(8*a.length/(Math.log(c.length)/Math.log(2))),p=Array(w);for(f=0;f<w;f++){n=[];for(e=h=0;e<u.length;e++)if(h=(h<<16)+u[e],g=Math.floor(h/d),h-=g*d,0<n.length||0<g)n[n.length]=g;p[f]=h;u=n}d="";for(e=p.length-1;0<=e;e--)d+=c.charAt(p[e]);return d}
...
chat_info:{},content_type:"avatar"==a.contentType?"avatar":"image"==a.contentType?8:4,file_dialog_start_handler:function(){},file_queued_handler:function(c){var e=a.getChatInfo&&a.getChatInfo()||{},f=YYIMChat.getServletPath().FILE_UPLOAD_SERVLET,g,h,n,u=e.to||YYIMChat.getUserNode();YYIMChat.isAnonymous()?(g=YYIMChat.getUserFullJID(),n="anonymous"):(g=YYIMChat.getUserNode(),n=YYIMChat.getToken());h=e.resource&&"anonymous"==e.resource.toLowerCase()?YYIMChat.getJIDUtil().buildUserJID(YYIMChat.getJIDUtil().getID(u),
"ANONYMOUS"):YYIMChat.getJIDUtil().getNode(u);f=f+"?fileName="+encodeURI(c.name,"utf-8")+"&uploadedSize=0&fileSize="+c.size+"&fromUser="+g+"&toUser="+h+"&token="+n+"&muc=1";"avatar"===a.contentType&&(f+="&isAvatar=true");this.settings.chat_info={to:YYIMChat.getJIDUtil().getNode(u),type:e.type?e.type:"chat",resource:e.resource};this.setUploadURL(f)},file_queue_error_handler:function(){a.error&&a.error(arguments)},file_dialog_complete_handler:function(){this.startUpload()},upload_start_handler:function(){},
...
breakPoints:!0,fileSplitSize:10485760,getUploadedSize:null,saveUploadedSize:null,saveInfoLocal:!0,onUploadStart:null,onUploadSuccess:null,onUploadComplete:null,onUploadError:null,onInit:null,onCancel:null,onSelect:null,uploadIdPrefix:"file_upload_",inputId:null,to:null,type:4,chatType:"chat",showProcess:!1,processId:null,resource:null},a),d=function(a,d,g,h,n,u){parseInt(SNSStorage.getLocalVal(g.name));YYIMChat.isAnonymous()?YYIMChat.getUserFullJID():(YYIMChat.getUserNode(),YYIMChat.getToken());c.resource&&
"anonymous"==c.resource.toLowerCase()?YYIMChat.getJIDUtil().buildUserJID(YYIMChat.getJIDUtil().getID(u),"ANONYMOUS"):"groupchat"==c.chatType?YYIMChat.getJIDUtil().buildChatGroupJID(YYIMChat.getJIDUtil().getNode(u)):YYIMChat.getJIDUtil().buildUserJID(YYIMChat.getJIDUtil().getNode(u));encodeURI(g.name,"utf-8");a=YYIMChat.getServletPath().REST_RESOURCE_SERVLET+YYIMChat.getTenancy().ETP_KEY+"/"+YYIMChat.getTenancy().APP_KEY+"/upload?token="+YYIMChat.getToken();n={name:encodeURI(g.name,"utf-8"),mediaType:8===
c.type?1:2,creator:YYIMChat.getUserNode(),receiver:YYIMChat.getJIDUtil().buildUserJID(YYIMChat.getJIDUtil().getNode(u)),size:n,original:1};"groupchat"==c.chatType&&(n.receiver=YYIMChat.getJIDUtil().buildChatGroupJID(YYIMChat.getJIDUtil().getNode(u)));a+="&"+jQuery.param(n);YYIMChat.log("file upload url",2,a);d.open(c.method,a,!0);d.setRequestHeader("X-Requested-With","XMLHttpRequest");a=new FormData;a.append(c.fileObjName,g);if(h)for(key in h)a.append(key,h[key]);d.send(a)};this.each(function(){var a=
jQuery(this),f=jQuery(".uploadify").length+1,g='<span id="'+c.uploadIdPrefix+f+'-queue" class="uploadify-queue"></span>',h=jQuery("#"+c.processId);0>=jQuery("#"+c.uploadIdPrefix+f+"-queue").length&&c.showProcess&&h.append(g);FileUpload.getInstanceByInputId(c.inputId).fileObj={uploadAllowed:!0,fileInput:a,uploadFileList:h.find("#"+c.uploadIdPrefix+f+"-queue"),url:c.uploader,fileFilter:[],uploadOver:!1,filter:function(a){for(var d=[],f=c.fileTypeExts.split(";"),e=0,g=a.length;e<g;e++){var h=a[e];parseInt(FileUpload.formatFileSize(h.size,
!0))>c.fileSizeLimit?alert("\u6587\u4ef6"+h.name+"\u5927\u5c0f\u8d85\u51fa\u9650\u5236\uff01"):"*"==c.fileTypeExts||0<=jQuery.inArray(h.name.split(".").pop().toLowerCase(),f)?d.push(h):alert("\u6587\u4ef6"+h.name+"\u7c7b\u578b\u4e0d\u5141\u8bb8\uff01")}return d},funSelect:function(d){for(var g=0,h=d.length;g<h;g++){var p=d[g];filesIndex+=","+p.index;var C="unknown";p.name&&(C=p.name.substr(p.name.lastIndexOf(".")+1));C=jQuery(c.itemTemplate.replace(/\${fileID}/g,"fileupload_"+f+"_"+p.index).replace(/\${fileTypeIcon}/g,
"res/skin/default/icons/filetype/"+C+".png").replace(/\${fileName}/g,p.name).replace(/\${fileSize}/g,FileUpload.formatFileSize(p.size)).replace(/\${instanceID}/g,a.attr("id")).replace(/\${continueUpload}/g,"continueUpload_"+f+"_"+p.index));c.auto&&C.find(".uploadbtn").remove();var m=0,z="0KB",t="0%";c.breakPoints&&(t=this.funGetUploadedSize(p),m=t/p.size*100+"%",z=FileUpload.formatFileSize(t),t=(t/p.size*100).toFixed(2)+"%",C.find(".uploadify-progress-bar").css("width",m));this.uploadFileList.append(C);
c.showUploadedSize&&(m='<span class="progressnum"><span id="isUploadingFileSize_'+f+"_"+p.index+'" class="uploadedsize">'+z+'</span>/<span class="totalsize">${fileSize}</span></span>'.replace(/\${fileSize}/g,FileUpload.formatFileSize(p.size)),C.find(".uploadify-progress").after(m));c.showUploadedPercent&&(m='<span class="up_percent" style="display:none">'+t+"</span>",C.find(".uploadify-progress").after(m));c.onSelect&&c.onSelect(d);c.auto?this.funUploadFile(p):C.find(".uploadbtn").click(function(a){return function(){FileUpload.getInstanceByInputId(c.inputId).fileObj.funUploadFile(a)}}(p));
C.find(".delfilebtn").click(function(a){return function(){FileUpload.getInstanceByInputId(c.inputId).fileObj.funDeleteFile(a)}}(p));C.find("#btnstop").click(function(a){return function(){deletefilesIndex+=","+a.index}}(p));C.find("#continueUpload_"+f+"_"+p.index).click(function(a){var d=a.index;return function(){if(0<deletefilesIndex.length&&-1<deletefilesIndex.indexOf(","+d)){for(var a=deletefilesIndex.split(","),e="",f=0;f<a.length;f++)a[f]!=d&&""!=a[f]&&(e+=","+a[f]);deletefilesIndex=e}(a=FileUpload.getFile(d,
FileUpload.getInstanceByInputId(c.inputId).fileObj.fileFilter))&&FileUpload.getInstanceByInputId(c.inputId).fileObj.funUploadFile(a)}}(p))}},onProgress:function(a,d,e){a=h.find("#fileupload_"+f+"_"+a.index+" .uploadify-progress").attr("lastLoaded")||0;d<a&&(a=0);d-=parseInt(a);a=(d/e).toFixed(4);a=1<a?1:a;c.onUploadProgress&&c.onUploadProgress({percent:a,loaded:d,total:e})},funGetProgressWidth:function(a){},funGetUploadedSize:function(a){if(c.getUploadedSize)return c.getUploadedSize(a);if(c.saveInfoLocal)return parseInt(SNSStorage.getLocalVal(a.name))||
...
isDelete=!0}});return this},funUploadFile:function(a){var e=!1,g=a,p=h.find("#fileupload_"+f+"_"+a.index),C=function(){FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&(p.find(".uploadify-progress-bar").css("width","100%"),c.showUploadedSize&&p.find(".uploadedsize").text(p.find(".totalsize").text()),c.showUploadedPercent&&p.find(".up_percent").text("100%"))};try{e=new XMLHttpRequest}catch(m){e=ActiveXobject("Msxml12.XMLHTTP")}if("undefined"==e)alert("\u6d4f\u89c8\u5668\u7248\u672c\u4e0d\u652f\u6301\uff0c\u8bf7\u66f4\u65b0\u7248\u672c");
else{31457280>=g.size||-1<g.type.indexOf("image/")?c.breakPoints=!1:c.breakPoints=!0;if(c.breakPoints){var z=a.name,t=a.id,v=a.index,B=a.size,q=parseInt(this.funGetUploadedSize(g));if(browserSys.firefox){var E=browserSys.firefox.split(".");a=6<E[0]&&15>E[0]?g.mozSlice(q,q+c.fileSplitSize):g.slice(q,q+c.fileSplitSize)}else browserSys.chrome?(E=browserSys.chrome.split("."),a=10<E[0]&&21>E[0]?g.webkitSlice(q,q+c.fileSplitSize):g.slice(q,q+c.fileSplitSize)):a=g.slice(q,q+c.fileSplitSize);a.name=z;a.id=
t;a.index=v}e.upload&&!1!==q&&e.upload.addEventListener("progress",function(d){FileUpload.getInstanceByInputId(c.inputId).fileObj.onProgress(a,d.loaded,g.size)},!1);var I=c.to;g.userJid=I;e.onreadystatechange=function(m){if(4==e.readyState){FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver=!0;if(200==e.status){m=JSON.parse(e.responseText);"success"==m.status&&(setTimeout(function(){h.find("#fileupload_"+f+"_"+g.index).fadeOut()},100),SNSStorage.removeLocal(a.name));var p=g.index;c.breakPoints?
(q+=c.fileSplitSize,"success"==m.status||isDelete?(FileUpload.getInstanceByInputId(c.inputId).fileObj.funSaveUploadedSize(g,q,!0),isDelete=!1):FileUpload.getInstanceByInputId(c.inputId).fileObj.funSaveUploadedSize(g,q,!1),-1<deletefilesIndex.indexOf(p)&&SNSStorage.removeLocal(g.name),q<B?(FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver=!1,-1<filesIndex.indexOf(","+p)&&-1==deletefilesIndex.indexOf(p)&&(browserSys.firefox?(p=browserSys.firefox.split("."),a=6<p[0]&&15>p[0]?g.mozSlice(q,
q+c.fileSplitSize):g.slice(q,q+c.fileSplitSize)):browserSys.chrome?(p=browserSys.chrome.split("."),a=10<p[0]&&21>p[0]?g.webkitSlice(q,q+c.fileSplitSize):g.slice(q,q+c.fileSplitSize)):a=g.slice(q,q+c.fileSplitSize),a.name=z,a.id=t,a.index=v,a.size=B,d(FileUpload.getInstanceByInputId(c.inputId).fileObj.url,e,a,c.formData,g.size,I))):C()):C();FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&(c.type==UPLOAD_AVATAR?c.onUploadSuccess&&c.onUploadSuccess(m):(m={id:Math.uuid(),body:{content:new SNSFile(a.name,
m.attachId,a.size),contentType:c.type,dateline:(new Date).getTime()},to:c.to,type:c.chatType,success:function(a){var d=Object.clone(a);d.to=YYIMChat.getJIDUtil().getID(a.to);c.onUploadSuccess&&c.onUploadSuccess(d)}},c.resource&&(m.resource=c.resource),YYIMChat.sendMessage(m)),setTimeout(function(){h.find("#fileupload_"+f+"_"+g.index).fadeOut()},c.removeTimeout))}else FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&c.onUploadError&&c.onUploadError(g,e.responseText),setTimeout(function(){h.find("#fileupload_"+
f+"_"+g.index).fadeOut()},100),SNSStorage.removeLocal(a.name);FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&(c.onUploadComplete&&c.onUploadComplete(g,e.responseText),FileUpload.getInstanceByInputId(c.inputId).fileObj.fileInput.val(""))}};c.onUploadStart&&c.onUploadStart();FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadAllowed=!0;d(this.url,e,a,c.formData,g.size,I)}}};c.onInit&&c.onInit()})}
...
var OPCODE={AUTH:new _Opcode("auth",1),PING:new _Opcode("ping",2),STREAMEND:new _Opcode("streamend",4),RECEIPTS:new _Opcode("receipts",4098),USER_MESSAGE:new _Opcode("userMessage",4112),CHATGROUP_MESSAGE:new _Opcode("chatGroupMessage",4144),PUBACCOUNT_MESSAGE:new _Opcode("pubaccountMessage",4176),SYNC_MESSAGE:new _Opcode("syncMessage",4208),RECEIPTS:new _Opcode("receipts",4098),NOTIFY_MESSAGE:new _Opcode("notifyMessage",4099),TRANSPARENT_MESSAGE:new _Opcode("transparentMessage",4432),INVITE_USERS:new _Opcode("inviteUsers",
4865),VCARD:new _Opcode("vcard",8209),VCARDS:new _Opcode("vcards",8209,8210),IQ_RESULT:new _Opcode("iqResult",8225),QUERY_USER:new _Opcode("queryUser",8464,8465),QUERY_CHATGROUP:new _Opcode("queryChatGroup",8496,8497),QUERY_PUBACCOUNT:new _Opcode("queryPubaccount",8528,8529),ROSTER_LIST:new _Opcode("rosterList",8736,8737),CHATGROUP_LIST:new _Opcode("chatGroupList",8752,8753),CHATGROUP_MEMBER_LIST:new _Opcode("chatGroupMemberList",8768,8769),PUBACCOUNT_LIST:new _Opcode("pubaccountList",8784,8785),
CHATGROUP_INFO:new _Opcode("chatGroupInfo",9008,9009),CHATGROUP_SHARED_FILES:new _Opcode("chatGroupSharedFiles",9010,9011),UPDATE_ROSTER:new _Opcode("updateRoster",9504),CONFIG_CHATGROUP:new _Opcode("chatGroupConfig",9520,9521),CREATE_GROUP:new _Opcode("createGroup",9522,9012),INVITE_GROUP_MEMBER:new _Opcode("inviteGroupMember",9523,9012),MODIFY_GROUP_INFO:new _Opcode("modifyGroupInfo",9524,9012),KICK_GROUP_MEMBER:new _Opcode("kickGroupMember",9525,9012),DISMISS_GROUP:new _Opcode("dismissgtoup",9528,
9013),TRANSFER_GROUP:new _Opcode("transferGroup",9529,8771),EXIT_GROUP:new _Opcode("exitGroup",9526,9013),ON_GROUP_TRANSFER:new _Opcode("groupOwnerTransfer",8771),ON_GROUP_UPDATE:new _Opcode("groupUpdate",9012),KICKED_GROUP:new _Opcode("kickedByGroup",9013),COLLECT_GROUP:new _Opcode("collectGroup",9527),FULL_SYNC_ROSTER:new _Opcode("fullSyncRoster",10016),DELTA_SYNC_ROSTER:new _Opcode("deltaSyncRoster",10018),FULL_SYNC_CHATGROUP:new _Opcode("fullSyncChatGroup",10032),DELTA_SYNC_CHATGROUP:new _Opcode("deltaSyncChatGroup",
10034),PRESENCE:new _Opcode("presence",12289),CHATGROUP:new _Opcode("chatGroup",13057,13058),DEL_GROUPMEMBER:new _Opcode("delGroupMember",9792),OPERATE_WHITEBOARD:new _Opcode("operateWhiteBoard",10241),LISTEN_WHITEBOARD:new _Opcode("listenWhiteBoard",10241,10242),UPDATE_WHITEBOARD:new _Opcode("updateWhiteBoard",10245),PACKET_ERROR:new _Opcode("packetError",16384),STREAM_ERROR:new _Opcode("streamError",16640),MESSAGE_RANGE:new _Range(4096,8192),IQ_RANGE:new _Range(8192,12288),PRESENCE_RANGE:new _Range(12288,
16384)},PACKET_STRUCT={CONSOLE_FRAME:new _Range(0,1),OPCODE:new _Range(1,3),PACKET_LEN:new _Range(3,7),VERSION:new _Range(7,9),SEQ_ID:new _Range(9,13)};function shallowClone(a){function c(){}c.prototype=a;return new c}function inheritPrototype(a,c){var d=shallowClone(c.prototype);d.constructor=a;a.prototype=d}function JumpPacket(a,c){this.sFrame=0;this.version=256;this.packetLen=this.seqId=0;this.content=a;this.opcode=c}
...
e),0<d.indexOf(c)?d.replace(c,""):d):0<a.indexOf(c)?a.replace(c,""):a):null},getNode:function(a){if(YYIMCommonUtil.isStringAndNotEmpty(a)){var c=k.getInstance().getAppkey(),d=a;if(-1<d.indexOf("@")){if(0===d.indexOf("@"))throw'"'+a+'" Can\'t start with  "@"!';d=d.substring(0,d.indexOf("@"))}if(-1<d.indexOf(".")){if(0===d.indexOf("."))throw'"'+a+'" Can\'t start with "."!';d=d.substring(0,d.indexOf("."))}return d?d+c:d}throw'"'+a+"\" Can't be Number Or Empty!";},getResource:function(a){return YYIMCommonUtil.isStringAndNotEmpty(a)?
-1!=a.indexOf("/")?a.substring(a.indexOf("/")+1):null:null},buildUserJID:function(a,c){return YYIMCommonUtil.isStringAndNotEmpty(a)?-1!=a.indexOf("@")?a:a+"@"+g+(c?"/"+c:""):null},getDomain:function(a){return YYIMCommonUtil.isStringAndNotEmpty(a)?-1!=a.indexOf("@")?a.substring(a.indexOf("@")+1):null:null},buildChatGroupJID:function(a){return YYIMCommonUtil.isStringAndNotEmpty(a)?-1!=a.indexOf("@")?a:a+"@"+m.DOMAIN.CHATROOM:null},buildPubAccountJID:function(a){return YYIMCommonUtil.isStringAndNotEmpty(a)?
-1!=a.indexOf("@")?a:a+"@"+m.DOMAIN.PUBACCOUNT:null}},g="im.yyuap.com",h="stellar.yyuap.com",n=5227,u=7075,w="http://im.yyuap.com/";jQuery.support.cors=!0;var p;-1<navigator.userAgent.indexOf("Safari")&&1>navigator.userAgent.indexOf("Chrome")?p=!1:(window.WebSocket=window.WebSocket||window.MozWebSocket,p=window.WebSocket?!0:!1);var C;C=window.localStorage?!0:!1;var m={RESOURCE:"web-v2.6",IS_ANONYMOUS:!0,MULTI_TENANCY:{ENABLE:!0,ETP_KEY:"etp",APP_KEY:"app",SEPARATOR:"."},RECEIPTSPACKET_AUTO:!1,SENDINTERVAL:30,
RECENTCONTACTSDAY:7,RECENTCONTACTSNUM:20,RECENTCONTACTSMODE:{NUMBER:"number",DAYS:"days"},MULTIPARTYCALL:{ADDRESS:"http://dudu.yonyoutelecom.cn/httpIntf/createConference.do",RESTADDRESS:"https://im.yyuap.com/sysadmin/rest/user/voip/make",ACCOUNT:"",KEY:"",PHONESMAXLENGTH:200,PARTYMAXLENGTH:12},SUPPORT:{isWebSocketSupport:p,isLocalConnectionSupport:C},CONNECTION:{TIMERVAL:2E3,WAIT:300,SECURE:!1,ALLOW_PLAIN:!0,ENABLE_WEBSOCKET:!0,ENABLE_LOCAL_CONNECTION:!0,USE_HTTPS:!1,SERVER_NAME:g,HTTP_BASE:h,HTTP_BIND_PORT:u,
WS_PORT:n},PING:{INTERVAL:3E4,DURATION:3E4,TIMEOUT:3E4},SERVLET:{FILE_UPLOAD_SERVLET:w+"sysadmin/fileUpload",FILE_DOWNLOAD_SERVLET:w+"sysadmin/download",FILE_DELETE_SERVLET:w+"sysadmin/cancel",AVATAR_SERVLET:w+"sysadmin/avatar",REST_RESOURCE_SERVLET:w+"sysadmin/rest/resource/",REST_HISTORY_SERVLET:w+"sysadmin/rest/history/",REST_VERSION_SERVLET:w+"sysadmin/rest/version/",REST_USER_SERVLET:w+"sysadmin/rest/user/",REST_UPLOAD_SERVLET:w+"im_upload/rest/resource/",REST_DOWNLOAD_SERVLET:w+"im_download/rest/resource/",
REST_TRANSFORM_SERVLET:w+"im_download/rest/transform/resource/"},DOMAIN:{CHATROOM:"conference."+g,SEARCH:"search."+g,PUBACCOUNT:"pubaccount."+g},MESSAGE:{SEND_TIMEOUT:3E4,MAX_CHARACHER:1E3,REQUEST_RECEIPTS:!0},LOG:{ENABLE:!0,FILTER_LEVEL:3},BROWSER:function(){var a=navigator.userAgent.toLowerCase();return{version:(a.match(/.+(?:rv|it|ra|ie)[\/: ]([\d.]+)/)||[])[1],safari:/webkit/.test(a),opera:/opera/.test(a),msie:/msie/.test(a)&&!/opera/.test(a),mozilla:/mozilla/.test(a)&&!/(compatible|webkit)/.test(a)}}(),
getHttpBindUrl:function(){return(this.CONNECTION.USE_HTTPS?"https://":"http://")+this.CONNECTION.HTTP_BASE+":"+this.CONNECTION.HTTP_BIND_PORT+"/http-bind/"},getWebSocketUrl:function(){return(this.CONNECTION.USE_HTTPS?"wss://":"ws://")+this.CONNECTION.HTTP_BASE+":"+this.CONNECTION.WS_PORT},useWebSocket:function(){return this.SUPPORT.isWebSocketSupport&&this.CONNECTION.ENABLE_WEBSOCKET},useLocalConnection:function(){return this.SUPPORT.isLocalConnectionSupport&&this.CONNECTION.ENABLE_LOCAL_CONNECTION},
getConnectionArgObj:function(){var a={domain:this.CONNECTION.SERVER_NAME,resource:this.RESOURCE,allow_plain:this.CONNECTION.ALLOW_PLAIN,secure:this.CONNECTION.SECURE,register:!1};this.IS_ANONYMOUS&&(a.authtype="saslanon");return a}},z={CHAT:"chat",AWAY:"away",XA:"xa",DND:"dnd",UNAVAILABLE:"unavailable"},t={MIXED:"mixed",SIMPLE:"simple",TEXT:2,FILE:4,IMAGE:8,SYSTEM:16,PUBLIC:32,AUDO:64,LOCATION:128,SHARE:256,WHITEBOARD:1024},v=function(){var a=function(){return{getVCard:function(a){var c={type:"get"};
YYIMCommonUtil.isStringAndNotEmpty(a.jid)?c.to=a.jid:null;d.getInstance().send(new JumpPacket(c,OPCODE.VCARD.SEND),function(a,c){c.complete&&c.complete();var d=a.vcard||{};d.userId=f.getID(d.username);a.enableFields&&(d.enableFields=a.enableFields);c.success&&c.success(d)},a)},setVCard:function(a){d.getInstance().send(new JumpPacket({type:"set",vcard:a.vcard},OPCODE.VCARD.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success()},a)},getVCards:function(a){d.getInstance().send(new JumpPacket({type:"roster"},
OPCODE.VCARDS.SEND),function(a,c){var d=a.vcards||[];vcards=[];for(i=d.length;i--;){var l=d[i];l.userId=f.getID(l.username);vcards.push(l)}c.complete&&c.complete();c.success&&c.success(vcards)},a)},getRostersPresence:function(a){jQuery.ajax({url:m.SERVLET.REST_USER_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/"+k.getInstance().getUserID()+"/presence/detail?token="+k.getInstance().getToken()+"&username="+a.username,type:"get",dataType:"json",cache:!1,success:function(c){a.success&&
a.success(c)},error:function(){a.error&&a.error()},complete:function(){a.complete&&a.complete()}})},getRecentContacts:function(a){var c={token:k.getInstance().getToken(),username:k.getInstance().getUserID()},d=m.SERVLET.REST_USER_SERVLET+"recentcontact/"+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY;a=a||{};a.mode=a.mode||m.RECENTCONTACTSMODE.DAYS;if(a.mode===m.RECENTCONTACTSMODE.NUMBER)d+="/recent/contacts",c.contactsCount="number"==typeof a.contactsCount?a.contactsCount:m.RECENTCONTACTSNUM;
else{var d=d+"/recentContacts",l=(new Date).getTime();c.startDate=l-864E5*("number"==typeof a.contactsDays?a.contactsDays:m.RECENTCONTACTSDAY);c.endDate=l}jQuery.ajax({url:d,type:"get",dataType:"json",data:c,cache:!1,success:function(c){var d=[],l;for(l in c)c[l].username&&d.push({id:f.getID(c[l].username),dateline:c[l].lastContactDate});d=d.sort(YYIMUtil.array.comparisonAsc("dateline"));a.success&&a.success(d)},error:function(){a.error&&a.error()},complete:function(){a.complete&&a.complete()}})}}}(),
c=function(){return{getRosterItems:function(a){var c=new JumpPacket({},OPCODE.ROSTER_LIST.SEND);d.getInstance().send(c,function(a,c){if(c){c.complete&&c.complete();for(var d=a.items||[],l=[],e=d.length||0,g={};e--;){var s=d[e],h=s.jid,s={id:f.getID(h),resource:f.getResource(h),ask:s.ask,recv:s.recv,name:s.name,photo:s.photo,subscription:s.subscription,group:s.groups};f.getDomain(h)!==m.DOMAIN.PUBACCOUNT&&(l.push(s),g[s.id]||"none"!==s.subscription||1!==s.recv||(g[s.id]=s))}for(var K in g)k.getInstance().onSubscribe({from:g[K].id,
type:"subscribe"});c.success&&c.success(JSON.stringify(l))}},a)},deleteRosterItem:function(a){var c={type:"set",ns:NS_ROSTER,item:{jid:a.jid,subscription:"remove"}};d.getInstance().send(new JumpPacket(c,OPCODE.UPDATE_ROSTER.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success(f.getID(c.jid))},a)},queryRosterItem:function(a){var c={start:YYIMCommonUtil.isNumber(a.start)?a.start:0,size:YYIMCommonUtil.isNumber(a.size)?a.size:20,fields:["Username","Name"],search:a.keyword};d.getInstance().send(new JumpPacket(c,
OPCODE.QUERY_USER.SEND),function(a,c){for(var d=a.items||[],l=[],e=d.length;e--;){var g=d[e],s=g.jid;s!==k.getInstance().getUserBareJID()&&l.push({id:f.getID(s),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?g.name:f.getID(s),photo:g.photo,email:g.email})}c.complete&&c.complete();c.success&&c.success({start:a.start,total:a.total,items:l})},a)},updateRosterItem:function(a){for(var c=a.roster,l={item:{jid:c.jid,name:c.name,groups:[]}},e=(c=c.groups)?c.length:0;e--&&YYIMCommonUtil.isStringAndNotEmpty(c[e]);)l.item.groups=
l.item.groups.concat(c[e]);d.getInstance().send(new JumpPacket(l,OPCODE.UPDATE_ROSTER.SEND),function(a,c){c.complete&&c.complete();400===a.code?c.error&&c.error(a):(a.to=f.getID(a.to),c.success&&c.success(a))},a)}}}(),e=function(){function a(c){if(c){for(var d=c.members.length,l=[];d--;){var e=c.members[d];e.id=f.getID(e.jid);l.push(e)}return{id:f.getID(c.from),name:c.naturalLanguageName||c.name,photo:c.photo,numberOfMembers:c.numberOfMembers,superLarge:c.superLarge,collected:c.collected,type:c.type,
creationdate:c.creationdate,creater:f.getID(c.operator),members:l,owners:c.owners}}}function c(a){if(a){for(var d=a.memberItems.length,l=[];d--;){var e=a.memberItems[d];e.id=f.getID(e.jid);l.push(e)}return{id:f.getID(a.from),members:l}}}return{queryChatGroup:function(a){var c={start:YYIMCommonUtil.isNumber(a.start)?a.start:0,size:YYIMCommonUtil.isNumber(a.size)?a.size:20,search:a.keyword};d.getInstance().send(new JumpPacket(c,OPCODE.QUERY_CHATGROUP.SEND),function(a,c){for(var d=a.items||[],l=[],e=
d.length;e--;){var g=d[e],s=g.jid;l.push({id:f.getID(s),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?g.name:f.getID(s)})}c.complete&&c.complete();c.success&&c.success({start:a.start,total:a.total,items:l})},a)},configChatGroup:function(a){var c={to:a.jid,roomname:a.name,roomdesc:a.desc,persistent:1,owners:[k.getInstance().getUserBareJID()],etp:m.MULTI_TENANCY.ETP_KEY,app:m.MULTI_TENANCY.APP_KEY};YYIMCommonUtil.isStringAndNotEmpty(a.photo)&&(c.photo=a.photo);d.getInstance().send(new JumpPacket(c,
OPCODE.CONFIG_CHATGROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success()},a)},getChatGroups:function(c){jQuery.ajax({url:m.SERVLET.REST_USER_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/rooms?token="+k.getInstance().getToken()+"&username="+k.getInstance().getUserID(),type:"get",dataType:"json",cache:!1,success:function(d){d=d.items||[];for(var l=[],e=d.length||0;e--;){var f=d[e];f.from=f.jid;(f=a(f))&&l.push(f)}c.success&&c.success(JSON.stringify(l))},error:function(){c.error&&
c.error()},complete:function(){c.complete&&c.complete()}})},getChatGroupInfo:function(a){var c={to:a.jid,type:"get",ns:NS_DISCO_INFO};d.getInstance().send(new JumpPacket(c,OPCODE.CHATGROUP_INFO.SEND),function(a,c){c.complete&&c.complete();var d=a.roomname?a.roomname:f.getID(c.jid),l=a.description;c.success&&c.success({name:d,desc:l})},a)},createChatGroup:function(c){var l={id:c.id,naturalLanguageName:c.name,from:k.getInstance().getUserBareJID(),invitees:c.members};d.getInstance().send(new JumpPacket(l,
OPCODE.CREATE_GROUP.SEND),function(c,d){d.complete&&d.complete();d.success&&d.success(a(c))},c)},inviteGroupMember:function(c){var l={id:c.id,to:c.to,from:k.getInstance().getUserBareJID(),invitees:c.members};d.getInstance().send(new JumpPacket(l,OPCODE.INVITE_GROUP_MEMBER.SEND),function(c,d){d.complete&&d.complete();d.success&&d.success(a(c))},c)},modifyChatGroupInfo:function(c){var l={id:c.id,naturalLanguageName:c.name,from:k.getInstance().getUserBareJID(),to:c.to};d.getInstance().send(new JumpPacket(l,
OPCODE.MODIFY_GROUP_INFO.SEND),function(c,d){d.complete&&d.complete();d.success&&d.success(a(c))},c)},kickGroupMember:function(c){var l={id:c.id,member:c.member,from:k.getInstance().getUserBareJID(),to:c.to};d.getInstance().send(new JumpPacket(l,OPCODE.KICK_GROUP_MEMBER.SEND),function(c,d){d.complete&&d.complete();d.success&&d.success(a(c))},c)},exitChatGroup:function(a){var c={id:a.id,from:k.getInstance().getUserBareJID(),to:a.to};d.getInstance().send(new JumpPacket(c,OPCODE.EXIT_GROUP.SEND),function(a,
c){c.complete&&c.complete();c.success&&c.success({from:f.getID(a.from),id:a.id,to:f.getID(a.to)})},a)},handleChatGroup:a,transferChatGroupOwner:c,collectChatGroup:function(a){var c={id:a.id,from:k.getInstance().getUserBareJID(),to:a.to,type:a.type};d.getInstance().send(new JumpPacket(c,OPCODE.COLLECT_GROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success({from:f.getID(c.to),id:a.id,to:k.getInstance().getUserID(),type:c.type,code:a.code,message:a.message})},a)},transferChatGroup:function(a){var l=
{id:a.id,to:a.to,from:k.getInstance().getUserBareJID(),newOwner:a.newOwner};d.getInstance().send(new JumpPacket(l,OPCODE.TRANSFER_GROUP.SEND),function(a,d){d.complete&&d.complete();d.success&&d.success(c(a))},a)},dismissChatGroup:function(a){var c={id:a.id,to:a.to,from:k.getInstance().getUserBareJID()};d.getInstance().send(new JumpPacket(c,OPCODE.DISMISS_GROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success({id:a.id,from:f.getID(a.from),to:f.getID(a.to)})},a)},getGroupSharedFiles:function(a){var c=
{token:k.getInstance().getToken(),username:k.getInstance().getUserID(),mucId:a.id,start:parseInt(a.start||0),size:parseInt(a.size||20)},d=m.SERVLET.REST_USER_SERVLET+"sharefiles/"+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/muc",d=d+("?"+jQuery.param(c));jQuery.ajax({url:d,type:"get",dataType:"json",cache:!1,success:function(c){c=c.list;for(var d=[],l=c.length;l--;){var e=c[l];e.creator=f.getID(e.creator);d.push(e)}a.success&&a.success(d)},error:function(){a.error&&a.error()},complete:function(){a.complete&&
a.complete()}})}}}(),g=function(){return{getGroupMembers:function(a){d.getInstance().send(new JumpPacket({type:"get",ns:NS_DISCO_ITEMS,to:a.jid},OPCODE.CHATGROUP_MEMBER_LIST.SEND),function(a,c){if(c){c.complete&&c.complete();var d=a.items;if(0!==(d&&d.length||0)){for(var l=[],e=-1,g=d.length;++e<g;){var s=d[e];l.push({id:f.getID(s.jid),name:s.name,photo:s.photo,affiliation:s.affiliation})}c.success&&c.success(JSON.stringify(l))}}},a)}}}(),h=function(){return{getPubAccountItems:function(a){var c=new JumpPacket({type:"get",
ns:NS_PUBACCOUNT,to:m.DOMAIN.PUBACCOUNT},OPCODE.PUBACCOUNT_LIST.SEND);d.getInstance().send(c,function(a,c){if(c){c.complete&&c.complete();for(var d=a.items||[],l=[],e=d.length||0;e--;){var g=d[e],s=g.jid,g={id:f.getID(s),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?g.name:f.getID(s),type:g.type};l.push(g)}c.success&&c.success(JSON.stringify(l))}},a)},queryPubaccount:function(a){var c={start:YYIMCommonUtil.isNumber(a.start)?a.start:0,size:YYIMCommonUtil.isNumber(a.size)?a.size:20,fields:["Accountname",
"Name"],search:a.keyword};d.getInstance().send(new JumpPacket(c,OPCODE.QUERY_PUBACCOUNT.SEND),function(a,c){for(var d=a.items||[],l=[],e=d.length;e--;){var g=d[e],s=g.jid;l.push({id:f.getID(s),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?g.name:f.getID(s),type:g.type})}c.complete&&c.complete();c.success&&c.success({start:a.start,total:a.total,items:l})},a)}}}(),n=function(){return{fullSyncRoster:function(a){d.getInstance().send(new JumpPacket({submits:a},OPCODE.FULL_SYNC_ROSTER.SEND))},deltaSyncRoster:function(a,
c){var l={};0<a.length&&(l.removes=a);0<c.length&&(l.sets=c);(0<a.length||0<c.length)&&d.getInstance().send(new JumpPacket(l,OPCODE.DELTA_SYNC_ROSTER.SEND))},fullSyncChatGroup:function(a){d.getInstance().send(new JumpPacket({submits:a},OPCODE.FULL_SYNC_CHATGROUP.SEND))},deltaSyncChatGroup:function(a,c){var l={};0<a.length&&(l.removes=a);0<c.length&&(l.sets=c);(0<a.length||0<c.length)&&d.getInstance().send(new JumpPacket(l,OPCODE.DELTA_SYNC_CHATGROUP.SEND))}}}();return{monitor:function(){var a=d.getInstance();
a.registerHandler(OPCODE.UPDATE_ROSTER.KEY,function(a){var c=a.item;a=f.getID(a.item.jid);"both"===c.subscription?(F.log("update or add: "+JSON.stringify(c)),k.getInstance().onRosterUpdateded({id:a,name:c.name,groups:c.groups})):"none"===c.subscription&&(F.log("delete: "+JSON.stringify(c)),k.getInstance().onRosterDeleted(a))});a.registerHandler(OPCODE.ON_GROUP_UPDATE.KEY,function(a){if(a=e.handleChatGroup(a))k.getInstance().onGroupUpdate(a)});a.registerHandler(OPCODE.ON_GROUP_TRANSFER.KEY,function(a){if(a=
e.transferChatGroupOwner(a))k.getInstance().onTransferGroupOwner(a)});a.registerHandler(OPCODE.KICKED_GROUP.KEY,function(a){a={id:a.id,from:f.getID(a.from),to:f.getID(a.to)};k.getInstance().onKickedOutGroup(a)});a.registerHandler(OPCODE.PUBACCOUNT_LIST.KEY,function(a){a=a.items;if(0!==(a&&a.length||0)){for(var c=[],d=a.length;d--;){var l=a[d],e=l.jid,l={id:f.getID(e),name:YYIMCommonUtil.isStringAndNotEmpty(l.name)?l.name:f.getID(e),type:l.type};c.push(l)}k.getInstance().onPubaccountUpdate(c)}})},
getVCard:a.getVCard,setVCard:a.setVCard,getVCards:a.getVCards,getRostersPresence:a.getRostersPresence,getRecentContacts:a.getRecentContacts,getRosterItems:c.getRosterItems,deleteRosterItem:c.deleteRosterItem,queryRosterItem:c.queryRosterItem,updateRosterItem:c.updateRosterItem,queryChatGroup:e.queryChatGroup,configChatGroup:e.configChatGroup,getChatGroups:e.getChatGroups,getChatGroupInfo:e.getChatGroupInfo,createChatGroup:e.createChatGroup,inviteGroupMember:e.inviteGroupMember,modifyChatGroupInfo:e.modifyChatGroupInfo,
kickGroupMember:e.kickGroupMember,exitChatGroup:e.exitChatGroup,collectChatGroup:e.collectChatGroup,transferChatGroup:e.transferChatGroup,dismissChatGroup:e.dismissChatGroup,getGroupSharedFiles:e.getGroupSharedFiles,getGroupMembers:g.getGroupMembers,getPubAccountItems:h.getPubAccountItems,queryPubaccount:h.queryPubaccount,fullSyncRoster:n.fullSyncRoster,deltaSyncRoster:n.deltaSyncRoster,fullSyncChatGroup:n.fullSyncChatGroup,deltaSyncChatGroup:n.deltaSyncChatGroup}}(),B=function(){function a(d,l){if(!0!==
q.get(d.id)&&(q.add(d.id,!0),d.from!==k.getInstance().getUserFullJID())){var g;try{g=JSON.parse(d.content)}catch(h){g=d.content}var n={content:g.content,contentType:d.contentType,dateline:d.dateline,atuser:g.atuser,extend:g.extend},r="groupchat"!=l?f.getID(d.from):{room:f.getID(d.from),roster:f.getID(f.getResource(d.from))},r={id:d.id,type:l,from:r,data:n};"chat"==l?(r.resource=f.getResource(d.from),r.to=f.getID(d.receiver||d.to)):r.to=k.getInstance().getUserID();if(!0===d.receipts){var p={to:d.from,
id:d.id};!0===m.RECEIPTSPACKET_AUTO?(c(p),e(p)):n.receipt=p}if(n.contentType)switch(n.contentType){case t.TEXT:g.style&&(r.data.style=g.style);try{k.getInstance().onTextMessage(r)}catch(L){YYIMChat.log("textMessHandleError:",0,r)}break;case t.IMAGE:r.data&&r.data.content&&r.data.content.path&&(r.data.content.attachId=r.data.content.path,r.data.content.path=YYIMChat.getFileUrl(r.data.content.path));try{k.getInstance().onPictureMessage(r)}catch(u){YYIMChat.log("imageMessHandleError:",0,r)}break;case t.FILE:r.data&&
r.data.content&&r.data.content.path&&(r.data.content.attachId=r.data.content.path,r.data.content.path=YYIMChat.getFileUrl(r.data.content.path));try{k.getInstance().onFileMessage(r)}catch(v){YYIMChat.log("fileMessHandleError:",0,r)}break;case t.SHARE:try{k.getInstance().onShareMessage(r)}catch(w){YYIMChat.log("shareMessHandleError:",0,r)}break;case t.SYSTEM:r.data.content=g;r.data&&r.data.content&&r.data.content.path&&(r.data.content.attachId=r.data.content.path,r.data.content.path=YYIMChat.getFileUrl(r.data.content.path));
try{k.getInstance().onSystemMessage(r)}catch(x){YYIMChat.log("systemMessHandleError:",0,r)}break;case t.PUBLIC:!g.content&&g.length&&(r.data.content=g);try{k.getInstance().onPublicMessage(r)}catch(y){YYIMChat.log("publicMessHandleError:",0,r)}break;case t.AUDO:r.data&&r.data.content&&r.data.content.path&&(r.data.content.attachId=r.data.content.path,r.data.content.path=YYIMChat.getFileUrl(r.data.content.path));try{k.getInstance().onAudoMessage(r)}catch(z){YYIMChat.log("AudoMessHandleError:",0,r)}break;
case t.LOCATION:r.data&&r.data.content&&r.data.content.path&&(r.data.content.attachId=r.data.content.path,r.data.content.path=YYIMChat.getFileUrl(r.data.content.path));try{k.getInstance().onLocationMessage(r)}catch(A){YYIMChat.log("LocationMessHandleError:",0,r)}break;case t.WHITEBOARD:try{k.getInstance().onWhiteBoardMessage(r)}catch(B){YYIMChat.log("WhiteBoardMessHandleError:",0,r)}break;default:YYIMChat.log("unhandlePacketError:",0,r)}}}function c(a){a=new JumpPacket({to:f.buildUserJID(f.getNode(a.to),
k.getInstance().getUserResource()),dateline:(new Date).getTime(),id:a.id},OPCODE.RECEIPTS.SEND);d.getInstance().send(a)}function e(a){a=new JumpPacket({to:f.buildUserJID(f.getNode(a.to),k.getInstance().getUserResource()),dateline:(new Date).getTime(),id:a.id,state:2},OPCODE.RECEIPTS.SEND);d.getInstance().send(a)}function g(a,c){if(m.RECEIPTSPACKET_AUTO){var d=m.SERVLET.REST_VERSION_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/"+c.id+"/ack?oldversion="+c.version+"&version="+a.version+
"&resource="+m.RESOURCE+"&token="+k.getInstance().getToken();jQuery.ajax({url:d,dataType:"json",type:"put",cache:!1,statusCode:{200:function(){k.getInstance().log("getVersion_sucess:",3,a.version)}}})}}function h(a){a.start||(a.start=0);a.size||(a.size=100);a.version||(a.version=-1);jQuery.ajax({url:m.SERVLET.REST_VERSION_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/"+a.id+"?version="+a.version+"&start="+a.start+"&size="+a.size+"&resource="+m.RESOURCE+"&token="+k.getInstance().getToken(),
dataType:"json",cache:!1,success:function(c){a.complete&&a.complete();if(c.packets&&c.packets.length){for(var d in c.packets)try{for(var l=c.packets[d],e=b64decode(l.opcode),f="0x",g=0;g<e.length;g++)var s=e[g].charCodeAt().toString(16),f=f+(1==s.length?"0"+s:s);var k=JSON.parse(l.body);k.opcode=f;p.unshift(k)}catch(K){}p.sort(YYIMUtil.array.comparisonAsc("dateline"));c.packets.length>=c.size?(a.start+=a.size,h(a)):n(c,a)}else c.packets&&c.packets.length||n(c,a)},error:function(c){k.getInstance().log("getOfflineMessage_error:",
0,c.statusText);a.error&&a.error()}})}function n(c,d){if(p.length){for(var e in p)if(p[e].id)switch(p[e].opcode){case "0x"+OPCODE.PRESENCE.SEND.toString(16):k.getInstance().onSubscribe({from:f.getID(p[e].from),type:p[e].type});break;case "0x"+OPCODE.USER_MESSAGE.SEND.toString(16):case "0x"+OPCODE.CHATGROUP_MESSAGE.SEND.toString(16):case "0x"+OPCODE.PUBACCOUNT_MESSAGE.SEND.toString(16):a(p[e],p[e].type);break;default:k.getInstance().log("unHandle_Packet:",3,p[e])}d.version=c.version-p.length;p=[];
g(c,d)}d.success&&d.success()}var q=new SNSBaseList,p=[];return{monitor:function(){var c=d.getInstance();c.registerHandler(OPCODE.USER_MESSAGE.KEY,function(c){a(c,c.type)});c.registerHandler(OPCODE.CHATGROUP_MESSAGE.KEY,function(c){a(c,c.type)});c.registerHandler(OPCODE.PUBACCOUNT_MESSAGE.KEY,function(c){a(c,c.type)});c.registerHandler(OPCODE.RECEIPTS.KEY,function(a){a.from=f.getID(a.from);a.to=f.getID(a.to);k.getInstance().onReceipts(a)});c.registerHandler(OPCODE.SYNC_MESSAGE.KEY,function(c){a(c,
c.type)});c.registerHandler(OPCODE.TRANSPARENT_MESSAGE.KEY,function(a){if(!0!==q.get(a.id)){q.add(a.id,!0);a.to=f.getID(a.to);try{k.getInstance().onTransparentMessage(a)}catch(c){YYIMChat.log("TransparentMessHandleError:",0,a)}}})},sendMessage:function(a){var c,l=a.body||{},e={id:a.id,type:a.type||"chat",contentType:l.contentType||t.TEXT,dateline:l.dateline,content:{atuser:l.atuser,extend:l.extend,content:l.content}},g=OPCODE.USER_MESSAGE.SEND;"groupchat"==a.type?(c=f.buildChatGroupJID(f.getNode(a.to)),
g=OPCODE.CHATGROUP_MESSAGE.SEND):"pubaccount"==a.type?(c=f.buildPubAccountJID(f.getNode(a.to)),g=OPCODE.PUBACCOUNT_MESSAGE.SEND):(e.receipts="1",c=a.resource?"anonymous"==a.resource.toLowerCase()?f.buildUserJID(f.getID(a.to),a.resource.toUpperCase()):a.to==YYIMChat.getUserID()?f.buildUserJID(f.getNode(a.to),a.resource):f.buildUserJID(f.getNode(a.to)):f.buildUserJID(f.getNode(a.to)));e.to=c;a.style&&(e.content.style=a.style);d.getInstance().send(new JumpPacket(e,g),function(c){40302==c.code?a.error&&
a.error():(c={id:a.id,type:a.type,data:{content:l.content,contentType:l.contentType,dateline:c.dateline,extend:a.extend}},"groupchat"===c.type?(c.to=YYIMChat.getUserID(),c.from={room:f.getID(a.to),roster:YYIMChat.getUserID()}):(c.to=f.getID(a.to),c.from=YYIMChat.getUserID()),c.body=c.data,c.data.content.path&&(c.data.content.attachId=c.data.content.path,c.data.content.path=YYIMChat.getFileUrl(c.data.content.path)),a.style&&(c.data.style=a.style),a.success&&a.success(c))})},addGroupMember:function(a,
c){d.getInstance().send(new JumpPacket({to:a,invites:c},OPCODE.INVITE_USERS.SEND))},getHistoryMessage:function(a){var c=m.SERVLET.REST_HISTORY_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/"+YYIMChat.getUserID()+"?token="+k.getInstance().getToken()+"&start="+a.start+"&size="+a.num+"&peer=";if("pubaccount"==a.chatType)c=m.SERVLET.REST_HISTORY_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/pubaccount/"+a.id+"?token="+k.getInstance().getToken()+"&start="+a.start+"&size="+
a.num,a.contentType&&(c+="&contentType="+a.contentType);else if("groupchat"==a.chatType)c=m.SERVLET.REST_HISTORY_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/historymuc/"+a.id+"?token="+k.getInstance().getToken()+"&start="+a.start+"&size="+a.num;else if("chat"==a.chatType&&(c=a.resource&&"anonymous"==a.resource?c+a.id:c+f.getNode(a.id),a.contentType))for(var d in t)if(a.contentType==t[d]){c+="&contentType="+a.contentType;break}k.getInstance().log("\u5386\u53f2\u8bb0\u5f55\uff1arequest URL",
2,c);jQuery.ajax({url:c,dataType:"json",cache:!1,success:function(c){YYIMChat.log("\u5386\u53f2\u8bb0\u5f55\uff1adata",2,c);for(var d=[],l=0;c.result&&l<c.result.length;l++){var e={fromId:f.getID(c.result[l].sender||c.result[l].pubaccount),toId:f.getID(c.result[l].receiver||k.getInstance().getUserID()),msgId:c.result[l].packetId||c.result[l].messageID,contentType:c.result[l].contentType,dateline:c.result[l].dateline||c.result[l].ts,packetId:c.result[l].packetId||c.result[l].messageID,type:a.chatType};
a.chatType&&"groupchat"==a.chatType&&(e.messageID=c.result[l].packetId||c.result[l].messageID,e.fromId=f.getID(c.result[l].mucId),e.fromRoster=f.getID(c.result[l].sender),e.from={room:f.getID(c.result[l].mucId),roster:f.getID(c.result[l].sender)});if(c.result[l].content){var g=e,s;if(s=c.result[l].content){s=JSON.parse(s);try{isNaN(Number(s.content))&&(s.content=JSON.parse(s.content),s.content.style&&(s.style=s.content.style,delete s.content.style),s.content.content&&(s.content=s.content.content))}catch(h){}}else s=
null;g.body=s;e.body.contentType=c.result[l].contentType;e.body.dateline=c.result[l].dateline||c.result[l].ts;e.body.content&&e.body.contentType&&(e.body.contentType==t.IMAGE||e.body.contentType==t.FILE)&&(e.body.content.attachId=e.body.content.path,e.body.content.path=e.body.content.path?YYIMChat.getFileUrl(e.body.content.path):null);d.push(e)}}YYIMCommonUtil.isFunction(a.success)&&a.success({count:Number(c.count),result:d})},error:function(c){a.error&&a.error();k.getInstance().log("getHistoryMessage_error:",
0,c.statusText)},complete:function(){a.complete&&a.complete()}})},getOfflineMessage:h,sendReceiptsPacket:c,sendReadedReceiptsPacket:e}}(),q=function(){return{monitor:function(){var a=d.getInstance();a.registerHandler(OPCODE.PRESENCE.KEY,function(a){if(a.type&&"unavailable"!=a.type)k.getInstance().onSubscribe({from:f.getID(a.from),type:a.type});else{var c={from:f.getID(a.from),resource:f.getResource(a.from),type:a.type,show:a.show,status:a.status};A.getInstance().addToOnline(c.from);a.type&&"unavailable"==
a.type&&(c.show=z.UNAVAILABLE,c.status=z.UNAVAILABLE,A.getInstance().removeFromOnline(c.from));YYIMCommonUtil.isStringAndNotEmpty(c.status)||(c.show=z.CHAT,c.status=z.CHAT);k.getInstance().onPresence(c)}});a.registerHandler(OPCODE.CHATGROUP.KEY,function(a){if("unavailable"==a.type)k.getInstance().onRoomMemerPresence({room:f.getID(a.from),member:{id:f.getID(a.jid)},type:"quit"});else k.getInstance().onRoomMemerPresence({room:f.getID(a.from),member:{id:f.getID(a.jid),nick:a.name?a.name:f.getID(a.jid),
affiliation:a.affiliation,role:a.role},type:"join"})})},addRosterItem:function(a){d.getInstance().send(new JumpPacket({type:"subscribe",to:a},OPCODE.PRESENCE.SEND))},approveSubscribe:function(a){d.getInstance().send(new JumpPacket({type:"subscribed",to:a},OPCODE.PRESENCE.SEND))},rejectSubscribe:function(a){d.getInstance().send(new JumpPacket({type:"unsubscribed",to:a},OPCODE.PRESENCE.SEND))},setPresence:function(a){var c={};YYIMCommonUtil.isStringAndNotEmpty(a.show)&&(c.show=a.show);YYIMCommonUtil.isStringAndNotEmpty(a.status)&&
(c.status=a.status);YYIMCommonUtil.isStringAndNotEmpty(a.priority)&&(c.priority=a.priority);YYIMCommonUtil.isStringAndNotEmpty(a.type)&&(c.type=a.type);d.getInstance().send(new JumpPacket(c,OPCODE.PRESENCE.SEND))},addPubAccount:function(a){d.getInstance().send(new JumpPacket({type:"subscribe",to:a.jid},OPCODE.PRESENCE.SEND),function(a,c){c.complete&&c.complete();a.from=f.getID(a.from);a.to=f.getID(a.to);c.success&&c.success(a)},a)},removePubAccount:function(a){d.getInstance().send(new JumpPacket({id:a.id,
type:"unsubscribe",to:a.to},OPCODE.PRESENCE.SEND),function(a,c){c.complete&&c.complete();a.from=f.getID(a.from);a.to=f.getID(a.to)||k.getInstance().getUserID();c.success&&c.success(a)},a)},joinChatGroup:function(a){var c={to:a.jid+"/"+k.getInstance().getUserNode()};d.getInstance().send(new JumpPacket(c,OPCODE.CHATGROUP.SEND),function(c,d){a.complete&&a.complete();a.success&&a.success({id:f.getID(c.from),affiliation:c.affiliation,role:c.role})},a)},delGroupMember:function(a,c,e){var f=parseInt(1E5+
1E5*Math.random());0<c.indexOf("@")&&(c=c.split("@")[0]);d.getInstance().send(new JumpPacket({id:f,to:a,member:c,role:"none"},OPCODE.DEL_GROUPMEMBER.SEND),function(a){e&&e(a)})},quitChatGroup:function(a){d.getInstance().send(new JumpPacket({type:"unavailable",to:a+"/"+k.getInstance().getUserNode()},OPCODE.CHATGROUP.SEND),function(){})}}}(),E=function(){return{monitor:function(){d.getInstance().registerHandler(OPCODE.UPDATE_WHITEBOARD.KEY,function(a){a.from=f.getID(a.from);k.getInstance().onWhiteBoardUpdated(a)})},
operateWhiteBoard:function(a){d.getInstance().send(new JumpPacket({id:a.id,wid:a.wid,name:a.name,origin:f.buildUserJID(f.getNode(a.origin)),operation:a.operation},OPCODE.OPERATE_WHITEBOARD.SEND),function(a,c){c.complete&&c.complete();a.from&&(a.from=f.getID(a.from));a.to&&(a.to=f.getID(a.to));c.success&&c.success(a)},a)},listenWhiteBoard:function(a){d.getInstance().send(new JumpPacket({id:a.id,wid:a.wid,operation:a.operation},OPCODE.LISTEN_WHITEBOARD.SEND),function(a,c){c.complete&&c.complete();a.from&&
(a.from=f.getID(a.from));a.to&&(a.to=f.getID(a.to));c.success&&c.success(a)},a)},updateWhiteBoard:function(a){var c={id:a.id,from:a.from,wid:a.wid,nodeId:a.nodeId,nodeContent:a.nodeContent,nodeText:a.nodeText,operation:a.operation};d.getInstance().send(new JumpPacket(c,OPCODE.UPDATE_WHITEBOARD.SEND),function(a,c){c.complete&&c.complete();a.from&&(a.from=f.getID(a.from));c.success&&c.success(a)},a)}}}();a.prototype.startPing=function(){d.getInstance().connected()&&(this.pingInterval=setInterval(this.ping.bind(this),
m.PING.INTERVAL))};a.prototype.stopPing=function(){clearTimeout(this.pingTimeout);clearInterval(this.pingInterval)};a.prototype.ping=function(){if(!((new Date).getTime()-this.lastPongTime<m.PING.DURATION)){var a=new JumpPacket(null,OPCODE.PING.SEND);try{d.getInstance().send(a),this.pingTimeout=setTimeout(this.timeoutHandler.bind(this),m.PING.TIMEOUT)}catch(c){F.log("SNSConnectService.ping",0,c),this.stopPing(),k.getInstance().onConnectError({errorCode:408,message:"\u8fde\u63a5\u5931\u8d25"})}}};a.prototype.pong=
function(){this.lastPongTime=(new Date).getTime();clearTimeout(this.pingTimeout)};a.prototype.timeoutHandler=function(){this.stopPing();k.getInstance().onConnectError({errorCode:408,message:"\u8fde\u63a5\u5931\u8d25"})};c.prototype._init=function(){F.log("YYIMConnectEventHandler.prototype.registerHandler",3);if(!this._inited){var a=d.getInstance();a.registerHandler("onConnect",this.onConnected);a.registerHandler("onDisconnect",this.onDisConnect);a.registerHandler("onStatusChanged",this.connectStatusChangeHandler);
a.registerHandler(OPCODE.STREAM_ERROR.KEY,this.onStreamError);a.registerHandler(OPCODE.PACKET_ERROR.KEY,this.onPacketError);this._inited=!0}};c.prototype.onConnected=function(){k.getInstance().onOpened();d.getInstance().getDaemon().startPing()};c.prototype.onConnectError=function(a){F.log("YYIMConnectEventHandler.prototype.onConnectError ",0,a);errorCode=a.getAttribute("code");d.getInstance().getDaemon().stopPing();if(401==errorCode||401==errorCode/10)k.getInstance().onAuthError({errorCode:401,message:"\u7528\u6237\u540d\u6216\u5bc6\u7801\u9519\u8bef"});
else k.getInstance().onConnectError({errorCode:errorCode,message:"\u8fde\u63a5\u5931\u8d25"})};c.prototype.onStreamError=function(a){F.log("YYIMConnectEventHandler.prototype.onPacketError ",0,a);d.getInstance().getDaemon().stopPing();if(401==a.code||401==a.code/10)k.getInstance().onAuthError({errorCode:401,message:"\u7528\u6237\u540d\u6216\u5bc6\u7801\u9519\u8bef"});else k.getInstance().onConnectError({errorCode:a.code,message:a.message})};c.prototype.onPacketError=function(a){F.log("YYIMConnectEventHandler.prototype.onPacketError ",
0,a)};c.prototype.onDisConnect=function(){k.getInstance().onClosed();d.getInstance().getDaemon().stopPing()};c.prototype.connectStatusChangeHandler=function(a){F.log("connectStatusChangeHandler",3,a);k.getInstance().onStatusChanged(a)};d.getInstance=function(){d._instance||(d._instance=new d,d._instance._init());return d._instance};d.prototype.getDaemon=function(){return this.daemon};d.prototype._init=function(){q.monitor();B.monitor();v.monitor();E.monitor();this.eventHandler._init();this.registerHandler(OPCODE.AUTH.KEY,
function(a){var c=new JSJaCJID(a.jid);a=f.getID(a.jid);k.getInstance()._user={jid:c,name:a};k.getInstance().onUserBind(a,c.getResource())});this.registerHandler(OPCODE.PING.KEY,this.getDaemon().pong.bind(this.getDaemon()))};d.prototype.registerHandler=function(a,c,d,e){if(this.connection)this.connection.registerHandler.apply(this.connection,arguments);else throw"connection is undefined!";};d.prototype.connected=function(){return this.connection&&this.connection.connected()?!0:!1};d.prototype.getConnection=
function(){this.connection||(m.useWebSocket()?this.connection=new JSJaCWebSocketConnection({httpbase:m.getWebSocketUrl()}):this.connection=new JSJaCHttpBindingConnection({httpbase:m.getHttpBindUrl(),timerval:m.CONNECTION.TIMERVAL,wait:m.CONNECTION.WAIT}));return this.connection};d.prototype.connect=function(a,c,d){this.connectArg||(this.connectArg=m.getConnectionArgObj());a&&(this.connectArg.username=a,this.connectArg.password=c);k.getInstance()._user={jid:new JSJaCJID(this.connectArg.username+"@"+
g+"/"+this.connectArg.resource),name:this.connectArg.username};this.connection.connect(this.connectArg)};d.prototype.disconnect=function(){this.daemon.stopPing();this.connection&&this.connection.disconnect()};d.prototype.send=function(a,c,d,e){this.waitingList.push({packet:a,callback:c,data:d,callbackContext:e});this.sending||this.sendInterval()};d.prototype.sendInterval=function(){var a=this;if(this.waitingList.length){this.sending=!0;var c=this.waitingList[0],d=(new Date).getTime()-this.lastSendTime;
d>=m.SENDINTERVAL?(this.sendJumpPacket(c),this.waitingList.shift(),this.lastSendTime=(new Date).getTime(),this.sendInterval()):setTimeout(function(){a.sendJumpPacket(c);a.waitingList.shift();a.lastSendTime=(new Date).getTime();a.sendInterval()},m.SENDINTERVAL-d)}else this.sending=!1};d.prototype.sendJumpPacket=function(a){return a.callbackContext?this.connection.sendJumpPacket(a.packet,a.callback.bind(a.callbackContext),a.data):this.connection.sendJumpPacket(a.packet,a.callback,a.data)};e.prototype.get=
function(){var a=this.xhr;a.open("GET",this.url,!0);e.prototype._listenFn.call(this);a.send()};e.prototype.post=function(){var a=this.xhr;a.open("POST",this.url,!0);e.prototype._listenFn.call(this);a.setRequestHeader("Content-Type","x-www-form-urlencoded");a.send(this.data)};e.prototype.isLoop=function(a){this.loop=a};e.prototype.stopLoop=function(){clearTimeout(_self.timeoutIndex)};e.prototype._listenFn=function(){var a=this,c=this.xhr;this.timeoutIndex=setTimeout(function(){a.loop&&e.prototype.get.call(a);
a.eCallback(c.responseText)},a.timeout);c.onreadystatechange=function(){4==c.readyState&&(clearTimeout(a.timeoutIndex),200==c.status?a.sCallback(c.responseText):a.eCallback(c.responseText))}};var I=function(){return{multiPartyCall:function(a){if(!0===a.accountMmanaged){var c={etpId:m.MULTI_TENANCY.ETP_KEY,appId:m.MULTI_TENANCY.APP_KEY,caller:a.caller,phones:a.phones,username:k.getInstance().getUserNode()};jQuery.ajax({url:m.MULTIPARTYCALL.RESTADDRESS+"?token="+k.getInstance().getToken(),type:"post",
data:JSON.stringify(c),dataType:"json",cache:!1,processData:!1,contentType:"application/json",headers:{},success:function(c){a.success&&a.success(c)},error:function(c){a.error&&a.error()}})}else c=(new Date).getTime(),c={caller:a.caller,phones:a.phones,account_identify:a.account,userId:k.getInstance().getUserBareJID(),timestamp:c,sign:hex_sha1(a.account+a.key+c)},jQuery.ajax({url:m.MULTIPARTYCALL.ADDRESS,type:"get",data:c,dataType:"jsonp",cache:!1,jsonp:"callback",success:function(c){a.success&&a.success(c)},
error:function(c){a.error&&a.error()}})}}}(),x=function(){this._provider};x.getInstance=function(){x._instance||(x._instance=new x);return x._instance};x.prototype.init=function(a){this._provider=a&&a.provider?a.provider:new H};x.prototype.getProvider=function(){this._provider||(this._provider=new H);return this._provider};x.prototype.getChatGroups=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getChatGroups)&&this.getProvider().getChatGroups(a)};x.prototype.addChatGroup=
function(a){q.joinChatGroup({jid:f.buildChatGroupJID(f.getNode(a.node)),success:function(){v.configChatGroup({jid:this.jid,name:a.name,desc:a.desc,error:a.error,success:function(){a.success&&a.success({name:a.name,node:a.node,id:a.id,nickname:k.getInstance().getUserID()})},complete:a.complete})},error:function(){a.error&&a.error()}});this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().addChatGroup)&&this.getProvider().addChatGroup(a)};x.prototype.createChatGroup=function(a){v.createChatGroup({id:Math.uuid(),
name:a.name,members:a.members,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};x.prototype.transferChatGroup=function(a){v.transferChatGroup({id:Math.uuid(),to:a.to,newOwner:a.newOwner,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};x.prototype.dismissChatGroup=function(a){v.dismissChatGroup({id:Math.uuid(),to:a.to,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};
x.prototype.inviteGroupMember=function(a){v.inviteGroupMember({id:Math.uuid(),to:a.to,members:a.members,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};x.prototype.modifyChatGroupInfo=function(a){v.modifyChatGroupInfo({id:Math.uuid(),to:a.to,name:a.name,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};x.prototype.kickGroupMember=function(a){v.kickGroupMember({id:Math.uuid(),to:a.to,member:a.member,success:function(c){a.success&&
a.success(c)},complete:function(){a.complete&&a.complete()}})};x.prototype.exitChatGroup=function(a){v.exitChatGroup({id:Math.uuid(),to:a.to,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};x.prototype.collectChatGroup=function(a){v.collectChatGroup({id:Math.uuid(),to:a.to,type:a.type,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};x.prototype.delGroupMember=function(a,c,d){q.delGroupMember(a,c,d)};x.prototype.quitChatGroup=
function(a){q.quitChatGroup(a);this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().quitChatGroup)&&this.getProvider().quitChatGroup(a)};x.prototype.queryChatGroup=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().queryChatGroup)&&this.getProvider().queryChatGroup(a)};x.prototype.joinChatGroup=function(a){q.joinChatGroup(a)};x.prototype.updateChatGroup=function(a){v.configChatGroup(a)};var H=function(){};H.prototype.getChatGroups=function(a){v.getChatGroups(a)};
H.prototype.addChatGroup=function(a){};H.prototype.quitChatGroup=function(a){};H.prototype.queryChatGroup=function(a){v.queryChatGroup(a)};var D=function(){this._provider};D.getInstance=function(){D._instance||(D._instance=new D);return D._instance};D.prototype.init=function(a){this._provider=a&&a.provider?a.provider:new J};D.prototype.getProvider=function(){this._provider||(this._provider=new J);return this._provider};D.prototype.getGroupMembers=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getGroupMembers)&&
this.getProvider().getGroupMembers(a)};D.prototype.addGroupMember=function(a,c){B.addGroupMember(a,c);this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().addGroupMember)&&this.getProvider().addGroupMember(a,c)};var J=function(){};J.prototype.getGroupMembers=function(a){v.getGroupMembers(a)};J.prototype.addGroupMember=function(a,c){};var A=function(){this._provider;this._onlineList=new SNSBaseList};A.getInstance=function(){A._instance||(A._instance=new A);return A._instance};A.prototype.addToOnline=
function(a){this._onlineList.add(a,!0)};A.prototype.removeFromOnline=function(a){this._onlineList.remove(a)};A.prototype.init=function(a){this._provider=a&&a.provider?a.provider:new G};A.prototype.getProvider=function(){this._provider||(this._provider=new G);return this._provider};A.prototype.getRosterItems=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getRosterItems)&&this.getProvider().getRosterItems(a)};A.prototype.addRosterItem=function(a){q.addRosterItem(a);this.getProvider()&&
YYIMCommonUtil.isFunction(this.getProvider().addRosterItem)&&this.getProvider().addRosterItem(a)};A.prototype.deleteRosterItem=function(a){v.deleteRosterItem(a);this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().deleteRosterItem)&&this.getProvider().deleteRosterItem(a)};A.prototype.queryRosterItem=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().queryRosterItem)&&this.getProvider().queryRosterItem(a)};A.prototype.getRostersPresence=function(a){this.getProvider()&&
YYIMCommonUtil.isFunction(this.getProvider().getRostersPresence)&&this.getProvider().getRostersPresence(a)};var G=function(){};G.prototype.getRosterItems=function(a){v.getRosterItems(a)};G.prototype.addRosterItem=function(a){};G.prototype.deleteRosterItem=function(a){};G.prototype.queryRosterItem=function(a){v.queryRosterItem(a)};G.prototype.getRostersPresence=function(a){v.getRostersPresence(a)};var y=function(){},F=new function(a){this.level=a?a:0==a?0:3;this.start=function(){};this.log=function(a,
c,d,e){if(m.LOG.ENABLE&&(c=c?c:0==c?0:3,!(c>this.level)&&"undefined"!=typeof console&&"undefined"!=typeof console.group))try{console.group(a);switch(c){case 0:console.error(a);console.trace();break;case 1:console.warn(a);console.trace();break;case 2:console.info(a);break;case 4:console.debug(a);break;default:console.log(a)}var l=arguments.length;if(2<l)for(var f=2;f<l;f++){var g=arguments[f];g&&(g instanceof JSJaCPacket?console.info(g.doc.xml):console.debug(g))}console.groupEnd()}catch(h){try{console.error(h)}catch(k){}}};
this.logParam=function(a){this.log("arguments:",a||3,this.logParam.caller.arguments)};this.setLevel=function(a){this.level=a;return this};this.getLevel=function(){return this.level}}(m.LOG.FILTER_LEVEL),k=function(){this._user;this.init();this._token={};this._anonymousUser=!1;this.appkey;this.version="2.0"};k.getInstance=function(){k._instance||(k._instance=new k);return k._instance};k.prototype.log=function(a,c,d,e){F.log(a,c,d,e)};k.prototype.init=function(a){a=a||{};this.onOpened=a.onOpened||y;
this.onClosed=a.onClosed||y;this.onAuthError=a.onAuthError||y;this.onStatusChanged=a.onStatusChanged||y;this.onConnectError=a.onConnectError||y;this.onUserBind=a.onUserBind||y;this.onPresence=a.onPresence||y;this.onSubscribe=a.onSubscribe||y;this.onRosterDeleted=a.onRosterDeleted||y;this.onRosterUpdateded=a.onRosterUpdateded||y;this.onGroupUpdate=a.onGroupUpdate||y;this.onTransferGroupOwner=a.onTransferGroupOwner||y;this.onKickedOutGroup=a.onKickedOutGroup||y;this.onPubaccountUpdate=a.onPubaccountUpdate||
y;this.onRoomMemerPresence=a.onRoomMemerPresence||y;this.onMessage=a.onMessage||y;this.onReceipts=a.onReceipts||y;this.onTextMessage=a.onTextMessage||y;this.onPictureMessage=a.onPictureMessage||y;this.onFileMessage=a.onFileMessage||y;this.onShareMessage=a.onShareMessage||y;this.onSystemMessage=a.onSystemMessage||y;this.onPublicMessage=a.onPublicMessage||y;this.onDeviceMessage=a.onDeviceMessage||y;this.onAudoMessage=a.onAudoMessage||y;this.onLocationMessage=a.onLocationMessage||y;this.onWhiteBoardMessage=
a.onWhiteBoardMessage||y;this.onTransparentMessage=a.onTransparentMessage||y;this.onWhiteBoardUpdated=a.onWhiteBoardUpdated||y};k.prototype.initUpload=function(){if(arguments&&SNSIMUploadUseFlash&&"function"==typeof SNSIMUploadUseFlash.prototype.addUploader)for(var a=0;a<arguments.length;a++){var c=arguments[a];"string"==typeof c.button_placeholder_id&&SNSIMUploadUseFlash.getInstance().addUploader(c)}};k.prototype.initSDK=function(a,c,d){var e=m.MULTI_TENANCY;e.ENABLE=!0;e.APP_KEY=a;e.ETP_KEY=c;this.appkey=
e.SEPARATOR+e.APP_KEY+e.SEPARATOR+e.ETP_KEY;d&&(h=d.address||h,m.CONNECTION.HTTP_BASE=h,n=d.wsport||n,m.CONNECTION.WS_PORT=n,u=d.hbport||u,m.CONNECTION.HTTP_BIND_PORT=u,w=d.servlet||w,m.SERVLET={FILE_UPLOAD_SERVLET:w+"sysadmin/fileUpload",FILE_DOWNLOAD_SERVLET:w+"sysadmin/download",FILE_DELETE_SERVLET:w+"sysadmin/cancel",AVATAR_SERVLET:w+"sysadmin/avatar",REST_RESOURCE_SERVLET:w+"sysadmin/rest/resource/",REST_HISTORY_SERVLET:w+"sysadmin/rest/history/",REST_VERSION_SERVLET:w+"sysadmin/rest/version/",
REST_USER_SERVLET:w+"sysadmin/rest/user/",REST_UPLOAD_SERVLET:w+"im_upload/rest/resource/",REST_DOWNLOAD_SERVLET:w+"im_download/rest/resource/",REST_TRANSFORM_SERVLET:w+"im_download/rest/transform/resource/"})};k.prototype.getTenancy=function(){return m.MULTI_TENANCY};k.prototype.getAppkey=function(){return this.appkey};k.prototype.setRosterProvider=function(a){A.getInstance().init({provider:a||new G})};k.prototype.setChatGroupProvider=function(a){x.getInstance().init({provider:a||new H})};k.prototype.setChatGroupMemberProvider=
function(a){D.getInstance().init({provider:a||new J})};k.prototype.setServer=function(a,c){m.CONNECTION.SERVER_NAME=a;m.CONNECTION.HTTP_BASE=c?c:a};k.prototype.disConnect=function(){d.getInstance().disconnect()};k.prototype.connect=function(){d.getInstance().connect()};k.prototype.getToken=function(){return this._token.token};k.prototype.getTokenExpiration=function(){return this._token.expiration};k.prototype.login=function(a,c,e){this._token={token:c,expiration:e};!YYIMCommonUtil.isStringAndNotEmpty(a)&&
m.IS_ANONYMOUS&&(this._anonymousUser=!0);!this.isAnonymous()&&m.MULTI_TENANCY.ENABLE&&(a=f.getNode(a));d.getInstance().connect(a,c)};k.prototype.logout=function(){d.getInstance().disconnect()};k.prototype.getUserBareJID=function(){return this._user.jid.getBareJID()};k.prototype.getUserFullJID=function(){return this._user.jid.toString()};k.prototype.getUserNode=function(){return f.getNode(this.getUserBareJID())};k.prototype.getUserID=function(){return f.getID(this.getUserBareJID())};k.prototype.getUserResource=
function(){return m.RESOURCE};k.prototype.fullSyncRoster=function(a){if(YYIMArrayUtil.isArray(a)){for(var c=a.length,d=[];c--;)YYIMCommonUtil.isStringAndNotEmpty(a[c].id)&&d.push({jid:f.buildUserJID(f.getNode(a[c].id)),name:a[c].name?a[c].name:a[c].id});v.fullSyncRoster(d)}};k.prototype.deltaSyncRoster=function(a,c){var d=-2,e=-2,g=[],h=[];if(YYIMArrayUtil.isArray(a))for(d=a.length;d--;)YYIMCommonUtil.isStringAndNotEmpty(a[d])&&g.push(f.buildUserJID(f.getNode(a[d])));if(YYIMArrayUtil.isArray(c))for(e=
c.length;e--;)YYIMCommonUtil.isStringAndNotEmpty(c[e].id)&&h.push({jid:f.buildUserJID(f.getNode(c[e].id)),name:c[e].name?c[e].name:c[e].id});-2===d&&-2===e||v.deltaSyncRoster(g,h)};k.prototype.fullSyncChatGroup=function(a){if(YYIMArrayUtil.isArray(a)){for(var c=a.length,d=[];c--;)YYIMCommonUtil.isStringAndNotEmpty(a[c].id)&&d.push({id:f.getID(a[c].id),name:a[c].name?a[c].name:a[c].id});v.fullSyncChatGroup(d)}};k.prototype.deltaSyncChatGroup=function(a,c){var d=-2,e=-2,g=[],h=[];if(YYIMArrayUtil.isArray(a))for(d=
a.length;d--;)YYIMCommonUtil.isStringAndNotEmpty(a[d])&&g.push(f.getID(a[d]));if(YYIMArrayUtil.isArray(c))for(e=c.length;e--;)YYIMCommonUtil.isStringAndNotEmpty(c[e].id)&&h.push({id:f.getID(c[e].id),name:c[e].name?c[e].name:c[e].id});-2===d&&-2===e||v.deltaSyncChatGroup(g,h)};k.prototype.setPresence=function(a){var c={};if(a){if(a.show)for(var d in z)if(z[d]===a.show){c.show=z[d];break}if(!c.show&&a.status)for(d in z)if(z[d]===a.status){c.show=z[d];break}c.status=a.status}c.show=c.show?c.show:z.AVAILABLE;
q.setPresence(c)};k.prototype.getVCard=function(a){var c={success:a.success,error:a.error,complete:a.complete};YYIMCommonUtil.isStringAndNotEmpty(a.id)&&(c.jid=f.buildUserJID(f.getNode(a.id)));v.getVCard(c)};k.prototype.getVCards=function(a){v.getVCards({success:a.success,error:a.error,complete:a.complete})};k.prototype.setVCard=function(a){v.setVCard({vcard:{nickname:a.vcard.nickname,photo:a.vcard.photo,email:a.vcard.email,mobile:a.vcard.mobile,telephone:a.vcard.telephone,organization:a.vcard.organization,
gender:a.vcard.gender,number:a.vcard.number,remarks:a.vcard.remarks,location:a.vcard.location,position:a.vcard.position},success:a.success,error:a.error})};k.prototype.getRosterItems=function(a){A.getInstance().getRosterItems(a)};k.prototype.addRosterItem=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&A.getInstance().addRosterItem(f.buildUserJID(f.getNode(a)))};k.prototype.approveSubscribe=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&q.approveSubscribe(f.buildUserJID(f.getNode(a)))};k.prototype.rejectSubscribe=
function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&q.rejectSubscribe(f.buildUserJID(f.getNode(a)))};k.prototype.deleteRosterItem=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&A.getInstance().deleteRosterItem({jid:f.buildUserJID(f.getNode(a.id)),success:a.success,error:a.error,complete:a.complete})};k.prototype.queryRosterItem=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.keyword)&&A.getInstance().queryRosterItem(a)};k.prototype.getRostersPresence=function(a){YYIMArrayUtil.isArray(a.username)&&
(a.username=JSON.stringify(a.username),A.getInstance().getRostersPresence(a))};k.prototype.getRecentContacts=function(a){v.getRecentContacts(a)};k.prototype.updateRosterItem=function(a){a&&a.roster&&YYIMCommonUtil.isStringAndNotEmpty(a.roster.id)&&v.updateRosterItem({roster:{jid:f.buildUserJID(f.getNode(a.roster.id)),name:a.roster.name,groups:a.roster.groups},success:a.success,error:a.error})};k.prototype.queryChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.keyword)&&x.getInstance().queryChatGroup(a)};
k.prototype.quitChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&x.getInstance().quitChatGroup(f.buildChatGroupJID(f.getNode(a)))};k.prototype.delGroupMember=function(a,c,d){YYIMCommonUtil.isStringAndNotEmpty(c)&&x.getInstance().delGroupMember(f.buildChatGroupJID(f.getNode(a)),f.buildUserJID(f.getNode(c)),d)};k.prototype.joinChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&x.getInstance().joinChatGroup({jid:f.buildChatGroupJID(f.getNode(a.id)),success:a.success,error:a.error})};
k.prototype.getChatGroupInfo=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&v.getChatGroupInfo({jid:f.buildChatGroupJID(f.getNode(a.id)),success:a.success,error:a.error})};k.prototype.getPubAccount=function(a){v.getPubAccountItems(a)};k.prototype.addPubaccount=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)?q.addPubAccount({jid:f.buildPubAccountJID(f.getNode(a.id)),success:a.success,error:a.error}):a.error&&a.error()};k.prototype.removePubaccount=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)?
q.removePubAccount({id:Math.uuid(),to:f.buildPubAccountJID(f.getNode(a.id)),success:a.success,error:a.error}):a.error&&a.error()};k.prototype.queryPubaccount=function(a){v.queryPubaccount(a)};k.prototype.getChatGroups=function(a){x.getInstance().getChatGroups(a)};k.prototype.addGroupMember=function(a){if(YYIMCommonUtil.isStringAndNotEmpty(a.roomId)&&YYIMArrayUtil.isArray(a.ids)){var c=f.buildChatGroupJID(f.getNode(a.roomId));a=a.ids.slice();for(var d=0,e=a.length;d<e;d++)a[d]=f.buildUserJID(f.getNode(a[d]));
D.getInstance().addGroupMember(c,a)}};k.prototype.addChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.node)&&x.getInstance().addChatGroup(a)};k.prototype.createChatGroup=function(a){YYIMArrayUtil.isArray(a.phones)||delete a.members;a.name?x.getInstance().createChatGroup(a):a.error&&a.error()};k.prototype.transferChatGroup=function(a){a&&"string"==typeof a.newOwner&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),x.getInstance().transferChatGroup(a)):a.error&&a.error()};k.prototype.dismissChatGroup=
function(a){a&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),x.getInstance().dismissChatGroup(a)):a.error&&a.error()};k.prototype.getGroupSharedFiles=function(a){a&&a.id&&v.getGroupSharedFiles(a)};k.prototype.inviteGroupMember=function(a){a.members&&YYIMArrayUtil.isArray(a.members)&&a.members.length&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),x.getInstance().inviteGroupMember(a)):a.error&&a.error()};k.prototype.modifyChatGroupInfo=function(a){a.name&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),
x.getInstance().modifyChatGroupInfo(a)):a.error&&a.error()};k.prototype.kickGroupMember=function(a){a.member&&"string"==typeof a.member&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),x.getInstance().kickGroupMember(a)):a.error&&a.error()};k.prototype.exitChatGroup=function(a){a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),x.getInstance().exitChatGroup(a)):a.error&&a.error()};k.prototype.collectGroup=function(a){a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),a.type="add",x.getInstance().collectChatGroup(a)):
a.error&&a.error()};k.prototype.removeCollectGroup=function(a){a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),a.type="remove",x.getInstance().collectChatGroup(a)):a.error&&a.error()};k.prototype.updateChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&x.getInstance().updateChatGroup({jid:f.buildChatGroupJID(f.getNode(a.id)),name:a.name,desc:a.desc,photo:a.photo,error:a.error,success:a.success,complete:a.complete})};k.prototype.getGroupMembers=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&
D.getInstance().getGroupMembers({jid:f.buildChatGroupJID(f.getNode(a.id)),success:a.success,error:a.error,complete:a.complete})};k.prototype.getHistoryMessage=function(a){if(!a.start||isNaN(a.start))a.start=0;if(!a.num||isNaN(a.num))a.num=100;B.getHistoryMessage(a)};k.prototype.getOfflineMessage=function(a){a=a||{};B.getOfflineMessage({id:this.getUserID(),success:a.success,error:a.error,complete:a.complete})};k.prototype.sendReceiptsPacket=function(a){B.sendReceiptsPacket(a)};k.prototype.sendReadedReceiptsPacket=
function(a){B.sendReadedReceiptsPacket(a)};k.prototype.sendMessage=function(a){B.sendMessage(a)};k.prototype.sendAccessoryMessage=function(a){a.id=Math.uuid();var c=new SNSFile(a.body.content.name,a.body.content.attachId,a.body.content.size);a.body={content:c,contentType:a.contentType||t.FILE,dateline:(new Date).getTime()};YYIMChat.sendMessage(a)};k.prototype.sendFormMessage=function(a){var c={token:this.getToken(),creator:this.getUserID()+"."+m.MULTI_TENANCY.APP_KEY+"."+m.MULTI_TENANCY.ETP_KEY,receiver:a.to+
"."+m.MULTI_TENANCY.APP_KEY+"."+m.MULTI_TENANCY.ETP_KEY,mediaType:a.mediaType||2,randomId:Math.uuid(),name:a.file.name,size:a.file.size},d=m.SERVLET.REST_RESOURCE_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/upload",d=d+("?"+jQuery.param(c));jQuery.ajax({url:d,type:"post",dataType:"json",data:a.data,processData:!1,contentType:!1,success:function(d){d&&d.attachId?(d={to:a.to,body:{content:{name:a.file.name,size:a.file.size,attachId:d.attachId}},type:a.type,success:function(c){var d=
{name:c.body.content.name,size:c.body.content.size,type:c.body.content.type,path:YYIMChat.getFileUrl(c.body.content.path)};c.body.content=d;c.to=YYIMChat.getJIDUtil(c.to);a.success&&a.success(c)}},d.contentType=1===c.mediaType?t.IMAGE:t.FILE,k.getInstance().sendAccessoryMessage(d)):a.error&&a.error()},error:function(c,d){a.error&&a.error()},complete:function(c,d){a.complete&&a.complete()}})};k.prototype.sendShareMessage=function(a){a.content=a.sharebody||a.content;a.contentType=t.SHARE;this.postMessage(a)};
k.prototype.sendWhiteBoardMessage=function(a){a.contentType=t.WHITEBOARD;this.postMessage(a)};k.prototype.sendTextMessage=function(a){a.content=a.msg||a.content;a.contentType=t.TEXT;this.postMessage(a)};k.prototype.postMessage=function(a){a.id=Math.uuid();a.type=a.type||"chat";a.body={extend:a.extend,content:a.content,contentType:a.contentType,dateline:(new Date).getTime()};"groupchat"===a.type&&YYIMArrayUtil.isArray(a.atuser)&&(a.body.atuser=a.atuser);a.style&&"string"!=typeof a.style&&(a.body.style=
JSON.stringify(a.style));this.sendMessage(a)};k.prototype.sendPic=function(a){var c=f.getNode(a.to),c="groupchat"==a.type?f.buildChatGroupJID(c):f.buildUserJID(c),c={fileTypeExts:"jpg;jpeg;png;bmp;gif",fileSizeLimit:102400,breakPoints:!1,saveInfoLocal:!1,removeTimeout:100,uploader:m.SERVLET.FILE_UPLOAD_SERVLET,uploadIdPrefix:"image_upload_",inputId:a.fileInputId,to:c,type:t.IMAGE,chatType:a.type,onUploadSuccess:a.success,onUploadProgress:a.progress,onUploadError:a.error,showProcess:!1,processId:"udnProcessBar"};
a.resource&&(c.resource=a.resource);FileUpload.getInstance(a.fileInputId,c);FileUpload.getInstance(a.fileInputId).sendFile(document.getElementById(a.fileInputId))};k.prototype.sendFile=function(a){var c=f.getNode(a.to),c="groupchat"==a.type?f.buildChatGroupJID(c):f.buildUserJID(c),c={fileTypeExts:"*",fileSizeLimit:99999999,breakPoints:!0,saveInfoLocal:!0,removeTimeout:100,uploader:m.SERVLET.FILE_UPLOAD_SERVLET,uploadIdPrefix:"bp_upload_",inputId:a.fileInputId,to:c,type:t.FILE,chatType:a.type,onUploadSuccess:a.success,
onUploadProgress:a.progress,onUploadError:a.error,showProcess:!0,processId:"udnProcessBar"};a.resource&&(c.resource=a.resource);FileUpload.getInstance(a.fileInputId,c);FileUpload.getInstance(a.fileInputId).sendFile(document.getElementById(a.fileInputId))};k.prototype.uploadAvatar=function(a){var c=f.getNode(a.to),c="groupchat"==a.type?f.buildChatGroupJID(c):f.buildUserJID(c);FileUpload.getInstance(a.fileInputId,{fileTypeExts:"jpg;jpeg;png;bmp;gif",fileSizeLimit:5120,breakPoints:!1,saveInfoLocal:!1,
removeTimeout:100,uploader:m.SERVLET.FILE_UPLOAD_SERVLET,uploadIdPrefix:"user_avatar_upload_",inputId:a.fileInputId,to:c,type:UPLOAD_AVATAR,onUploadSuccess:a.success,onUploadError:a.error,showProcess:!1,processId:"udnProcessBar"});FileUpload.getInstance(a.fileInputId).sendFile(document.getElementById(a.fileInputId))};k.prototype.getServerName=function(){return m.CONNECTION.SERVER_NAME};k.prototype.getTransformFileList=function(a){jQuery.ajax({url:m.SERVLET.REST_TRANSFORM_SERVLET+"docInfo",type:"get",
data:{attachId:a.attachId,token:this.getToken(),downloader:this.getUserNode()},dataType:"json",cache:!1,success:function(c){a.success&&a.success(c)},error:function(){a.error&&a.error()},complete:function(){a.complete&&a.complete()}})};k.prototype.getFileUrl=function(a){var c,d;this.isAnonymous()?(c=this.getUserFullJID(),d="anonymous"):(c=this.getUserNode(),d=this.getToken());return m.SERVLET.FILE_DOWNLOAD_SERVLET+"?attachId="+a+"&fromUser="+c+"&token="+d};k.prototype.getServletPath=function(){return m.SERVLET};
k.prototype.getJIDUtil=function(){return f};k.prototype.getArrayUtil=function(){return YYIMArrayUtil};k.prototype.isAnonymous=function(){return this._anonymousUser};k.prototype.enableAnonymous=function(){return m.IS_ANONYMOUS};k.prototype.getBrowser=function(){return m.BROWSER};k.prototype.isOnline=function(a){return!0==A.getInstance()._onlineList.get(a)};k.prototype.multiPartyCall=function(a){if("undefined"!==typeof a&&"undefined"!==typeof a.caller&&YYIMArrayUtil.isArray(a.phones)&&a.phones.length)if(YYIMRegularUtil.phone.test(a.caller)){var c=
[],d;for(d in a.phones){var e=a.phones[d].toString();if(YYIMRegularUtil.phone.test(e)&&-1===c.indexOf(e)&&(c.push(e),e=c.join(","),c.length>m.MULTIPARTYCALL.PARTYMAXLENGTH||e.length>m.MULTIPARTYCALL.PHONESMAXLENGTH)){c.pop();break}}if(c.length){a.caller=a.caller.toString();a.phones=c;if(!0!==a.accountMmanaged&&(a.phones=c.join(","),a.account=a.account?a.account:m.MULTIPARTYCALL.ACCOUNT,a.key=a.key?a.key:m.MULTIPARTYCALL.KEY,"undefined"===typeof a.account||"undefined"===typeof a.key)){a.error&&a.error();
return}I.multiPartyCall(a)}else a.error&&a.error()}else a.error&&a.error();else a.error&&a.error()};k.prototype.operateWhiteBoard=function(a){var c={id:Math.uuid(),origin:a.origin,operation:a.operation||"create",success:a.success,error:a.error,complete:a.complete};"create"!==a.operation&&(c.wid=a.wid);if("create"===a.operation||"rename"===a.operation)c.name=a.name;c.wid&&c.origin&&"listen"===c.operation?E.listenWhiteBoard(c):!c.origin||"create"!==c.operation&&"end"!==c.operation&&"rename"!==c.operation?
a.error&&a.error():E.operateWhiteBoard(c)};k.prototype.updateWhiteBoard=function(a){a.wid&&a.nodeId?(a.id=Math.uuid(),a.from=k.getInstance().getUserFullJID(),a.operation="delete"===a.operation?"delete":"update","update"!=a.operation||a.nodeContent?E.updateWhiteBoard(a):a.error&&a.error()):a.error&&a.error()};return k.getInstance()}();
